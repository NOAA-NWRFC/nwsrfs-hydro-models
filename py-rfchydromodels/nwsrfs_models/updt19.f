...
CGW     .$Source: /fs/hseb/ob90/ohd/ofs/src/fcst_snow/RCS/updt19.f,v $
CGW     . $',                                                             '
CGW     .$Id: updt19.f,v 1.3 2006/10/03 19:38:58 hsu Exp $
CGW     . $' /
C    ===================================================================
C
C.......................................
...
CGW      IF(OSC.EQ.0.0) GO TO 255
CGW      WRITE(IPR,907)
CGW  907 FORMAT(1H0,112H**WARNING** AREAL EXTENT OF SNOW IS NOT UPDATED FOR
CGW     1 OBSERVED AREAL EXTENT VALUES IN THE RANGE GT 0.0 TO LE 0.05.)
CGW      CALL WARN
      GO TO 290
C
C     CAN ONLY GET RID OF SNOW BY SETTING WATER EQUIVALENT TO ZERO -
C       NOT BY SETTING AESC TO ZERO
CGW  255 WRITE(IPR,908)
CGW  908 FORMAT(1H0,96H**WARNING** SNOW CANNOT BE REMOVED BY SETTING COVER 
CGW     1TO ZERO - MUST SET WATER EQUIVALENT TO ZERO.)
CGW      CALL WARN
CEA     NO SNOW REMAINS
CEA  255 CALL ZERO19
CEA      COVER=0.0
