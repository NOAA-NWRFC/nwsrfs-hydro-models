...
CGW      SUBROUTINE FLAG7 (P,C,QA,QB,QT,NDT,COTIME,IB)
      SUBROUTINE FLAG7 (P,C,QA,QB,NDT)
C.......................................................................
C
...
CGW      	WRITE(MESSAGESTRING,*) 'ENTER FLAG7'
...
CGW        CALL FPRPC7(NP,P,NC,C)
      ...
      ENDIF
C
CGW      WRITE(MESSAGESTRING,900)(QA(I),I=1,MAXDEBUG)
CGW call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
CGW      END IF
C
...
CFC      WRITE(IPR,901)
CGW      WRITE(MESSAGESTRING,901)
CGW      call logfromfortran(WARNING_LEVEL,MESSAGESTRING)
CGW  901 FORMAT(1H0,10X,8H** ERROR/
CGW     1  11X,47HATTEMPT TO WRITE BEYOND THE END OF THE QT ARRAY)
CFC      CALL ERROR
      GO TO 200
C
  115 QT(LQT)=QA(I)
...
C
  120 CONTINUE
CGW  120 IF(FEWSDEBUG .GE. 2) THEN
CGW         WRITE(MESSAGESTRING,*)'Length of C array =', LC,
CGW     1 'Number of C values =', NC
CGW         call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
CGW      ENDIF
      IF(LC.LT.NC)GO TO 125
CGW      WRITE(MESSAGESTRING,902)
CGW      call logfromfortran(WARNING_LEVEL,MESSAGESTRING)
CFC      WRITE(IPR,902)
CGW  902 FORMAT(1H0,10X,8H** ERROR/
CGW     1  11X,46HATTEMPT TO WRITE BEYOND THE END OF THE C ARRAY)
CFC      CALL ERROR
      GO TO 200
C
  125 C(LC)=QA(I)
...
C
  218 CONTINUE
CGW  218 IF(FEWSDEBUG .GE. 1) THEN
C LC just write max of 100 values for debug
CGW          MAXDEBUG=LQT
CGW      IF(MAXDEBUG.GT.100)THEN
CGW        MAXDEBUG=100
CGW      ENDIF

CGW      WRITE(MESSAGESTRING,905) (QT(I),I=1,MAXDEBUG)
CGW	  call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
...
C
  500 CONTINUE
CGW  500 IF(FEWSDEBUG .LT. 1) RETURN
...
C LC just write max of 100 values for debug
      ...
      MAXDEBUG=100
      ENDIF
CGW	WRITE(MESSAGESTRING,903)(QB(I),I=1,MAXDEBUG)
CGW        call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 
CGW  903 FORMAT(1H0,10X,4HQB =/(1X,10F12.3))
...
C LC just write max of 100 values for debug
      ...
      MAXDEBUG=100
      ENDIF
CGW	WRITE(MESSAGESTRING,904)(C(I),I=1,MAXDEBUG)
CGW        call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)  
...
CGW  WRITE(MESSAGESTRING,905)(QT(I),I=1,MAXDEBUG)
CGW        call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
CGW  905 FORMAT(1H0,10X,4HQT =/(1X,10F12.3))
C      
CGW      WRITE(MESSAGESTRING,906)NDT,COTIME,LQT
CGW      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
CFC      WRITE(IODBUG,906)NDT,COTIME,LQT
CGW  906 FORMAT(' EXIT FLAG7: NDT=',I10,' COTIME=',F10.2,' LQT=',I10)
C
      RETURN
      END
