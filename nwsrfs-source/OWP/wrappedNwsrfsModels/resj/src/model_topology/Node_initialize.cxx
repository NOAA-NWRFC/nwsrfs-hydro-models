...
*****************************/
    ...
    if( _diversion_ts->allocateDataSpace() ) {
        ...
        "%s (%s) - Troubles allocating data space for diversion TS on %s.", 
        warnStr, routine, _id );
        return( STATUS_FAILURE );
    }
...
/*  ==============  Statements containing RCS keywords:  */
{static char rcs_id1[] = "$Source: /fs/hseb/ob83/ohd/ofs/src/resj_topology/RCS/Node_initialize.cxx,v $";
 static char rcs_id2[] = "$Id: Node_initialize.cxx,v 1.7 2007/10/02 20:46:39 hsu Exp $";}
/*  ===================================================  */
