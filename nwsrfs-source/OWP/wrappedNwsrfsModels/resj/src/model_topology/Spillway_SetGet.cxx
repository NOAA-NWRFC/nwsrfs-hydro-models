...
int Spillway :: setCOstring( )
{
	...
	char temp_str[54+8+80+1];	// Labels, value, future space, end
	...
	COtype[6] = '\0';
	sprintf( temp_str, 
		"%-12.12s%-12.12s%6.6s%-12.12s%-12.12s%8.8s%80.80s",
	//LX6 - COtype, _id, "-999", "SPILLWAY", _owner->_id, value_str, 
                "METHOD", _id, "-99999", "SPILLWAY", _owner->_id, value_str, 
		future_str );
