...
/*  ==============  Statements containing RCS keywords:  */
{static char rcs_id1[] = "$Source: /fs/hseb/ob83/ohd/ofs/src/resj_topology/RCS/MaxStage_initialize.cxx,v $";
 static char rcs_id2[] = "$Id: MaxStage_initialize.cxx,v 1.6 2007/10/09 13:39:28 hsu Exp $";}
/*  ===================================================  */
