//------------------------------------------------------------------------------
// SetRelease :: SetGet - Set/gets for data members.
//------------------------------------------------------------------------------
...
void SetRelease :: setInactiveState()
{
...
int SetRelease :: setCOstring( )
{
	char routine[]="SetRelease::setCOstring";
	char future[9]="*FUTURE*";
	char COtype[13]="METHOD";
	char tsStep_str[5], tblStep_str[5], future_str[17], value_str[9];
	char temp_str[54+8+16+1];	// Labels, values, future space, end
	...
	COtype[6] = '\0';
	sprintf( temp_str, 
		"%-12.12s%-12.12s%6.6s%-12.12s%-12.12s%8.8s%16.16s",
		COtype, _id, "-99999", "SETRELEASE", _owner->_id, value_str, 
		future_str );
...
int SetRelease :: setCOstring( TSDate& cur_date )
{
	char routine[]="SetRelease::setCOstring";
	int success;
...
/*  ==============  Statements containing RCS keywords:  */
{static char rcs_id1[] = "$Source: /fs/hseb/ob81/ohd/ofs/src/resj_topology/RCS/SetRelease_SetGet.cxx,v $";
 static char rcs_id2[] = "$Id: SetRelease_SetGet.cxx,v 1.4 2006/10/26 15:34:13 hsu Exp $";}
/*  ===================================================  */
