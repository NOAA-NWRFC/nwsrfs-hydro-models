C MEMBER LU3F51
C DESC PERFORM 3-VARIABLE TABLE LOOKUP
C
C@PROCESS LVL(77)
C
      SUBROUTINE LU3F51(A1,A2,T,R)
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcst_ssarresv/RCS/lu3f51.f,v $
     . $',                                                             '
     .$Id: lu3f51.f,v 1.1 1996/03/21 13:39:29 page Exp $
     . $' /
C    ===================================================================
C
C
      IF(NS2.NE.2 .OR. FEWSDEBUG.LT.2) GO TO 10
      IEND=T(1)
      WRITE(MESSAGESTRING,5) (T(I),I=2,IEND),T(1),A1,A2
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 5    FORMAT(/5X,'3-VARIABLE ARRAY, NPT, X, Z:'/(1X,7F10.0))
 10   CONTINUE
CC  KSH CHANGE END
CC
C
...
C         ON THIS Z CURVE. (ENTERED ALSO FROM STMT 420)
 ...
 218  X2 = T(IXI)
      IF(X-X2) 220,242, 260
C        POINTS ARE ASCENDING, ASSUME T(IX2) VALID POINT
...
C        A1 EQUALS X OF POINT AT IXI, NO INTERP NEEDED.
 270  Y = T(IXI+1)
      GO TO 400
C        BRACKETING POINTS FOUND AT T(IX) AND T(IXI)
 280  IX2 = IXI
