...
C  PUNCH ELVSSTOR CURVE
      ...
      JP=IE-IB+1
      FMT2(9:12)=FNV(JP)
      WRITE(MESSAGESTRING,FMT2) KEYWD(1),(X(I),I=IB,IE),AMP(IAMP)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 ...
 115  JP=IE-IB+1
      FMT2(9:12)=FNV(JP)
      WRITE(MESSAGESTRING,FMT2) KEYWD(3),(X(I),I=IB,IE),AMP(IAMP)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
      IF(IE .GE. NVAL)GO TO 116
      IB=IE+1
      IE=IE+6
...
C
      ...
      IF(IBWTYP.EQ.2) THEN
          WRITE(MESSAGESTRING,1820) (X(I),Y(I),Z(I),I=IB,IE),AMP(IAMP)
	  call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
1820      FORMAT('BACKTABL',1X,2(F10.0,2F10.2),1X,A1)
      ENDIF
      IF(IBWTYP.EQ.1) THEN
          WRITE(MESSAGESTRING,1830) (X(I),Y(I),Z(I),I=IB,IE),AMP(IAMP)
1830      FORMAT('BACKTABL',1X,2(F10.0,F10.2,F10.0),1X,A1)
 ...
 140  IF(IE.GE.NVAL) IAMP=2
      IF(IBWTYP.EQ.2) THEN
      IF(IE.GT.IB) THEN
          WRITE(MESSAGESTRING,1825) (X(I),Y(I),Z(I),I=IB,IE),AMP(IAMP)
	  call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
1825      FORMAT(9X,2(F10.0,2F10.2),1X,A1)
      ENDIF
      IF(IE.EQ.IB) THEN
          WRITE(MESSAGESTRING,1826) (X(I),Y(I),Z(I),I=IB,IE)
	  call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 1826     FORMAT(9X,F10.0,2F10.2)
      ...
      IF(IBWTYP.EQ.1) THEN
        IF(IE.GT.IB) THEN
          WRITE(MESSAGESTRING,1835) (X(I),Y(I),Z(I),I=IB,IE),AMP(IAMP)
	  call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
1835      FORMAT(9X,2(F10.0,F10.2,F10.0),1X,A1)
        ENDIF
        IF(IE.EQ.IB) THEN
         WRITE(MESSAGESTRING,1836) (X(I),Y(I),Z(I),I=IB,IE)
	 call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
...
cc      IBWTYP=PO(LPO)
      WRITE(MESSAGESTRING,1715) BWTYP(IBWTYP),CNTLBY(ISTYP)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
...
C  PUNCH MAXEL
      ELMAX=PO(LPO)
      WRITE(MESSAGESTRING,1730) ELMAX
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
...
C  PUNCH MINEL
      ELMIN=PO(LPO)
      WRITE(MESSAGESTRING,1731) ELMIN
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
...
C  PUNCH MINQREL
      QRELMN=PO(LPO)
      WRITE(MESSAGESTRING,1732) QRELMN
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
...
C  PUNCH SHUTRESV
      QSHUT=PO(LPO)
      WRITE(MESSAGESTRING,1733) QSHUT
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 1733 FORMAT('SHUTRESV',1X,F10.0)
      LPO=LPO+1
C
      WRITE(MESSAGESTRING,515)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 515  FORMAT('ENDP')
CC
C***********************************************************************
C     TIME SERIES INFORMATION
      WRITE(MESSAGESTRING,520)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 520  FORMAT('TIME-SERIES')
      ...
      IT=PO(LTS+3)
      WRITE(MESSAGESTRING,750) GTSKW(II),PO(LTS),PO(LTS+1),PO(LTS+2),IT
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 750  FORMAT(A8,2X,2A4,2X,A4,2X,I2)
152   LTS=LTS+5
155   CONTINUE
      WRITE(MESSAGESTRING,525)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 525  FORMAT('ENDTS')
C
...
C
 ...
 530  FORMAT('CARRYOVER')
      ...
      LCO=LCO+4
C
      WRITE(MESSAGESTRING,1610) QOI
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
      WRITE(MESSAGESTRING,1612) EL1
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
      WRITE(MESSAGESTRING,1614) STO
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
      IF(IRES.EQ.2) GO TO 160
      IF(PO(LTSQL1).EQ.BLANK .AND. PO(LTSQL2).NE.BLANK) THEN
         WRITE(MESSAGESTRING,1616) QL1
	 call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
      ENDIF
 160  CONTINUE
