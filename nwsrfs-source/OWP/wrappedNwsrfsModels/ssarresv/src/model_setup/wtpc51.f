...
C    FEWSDEBUG   - DEBUG FLAG =1,ON; =0,OFF (INPUT)
...
C      
 ...
 1605 FORMAT(' *** POS. NOS. :',I4,' THRU ',I4)
      WRITE(MESSAGESTRING,1610) (PO(J),J=I,IE)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
  550 CONTINUE
 ...
 1601 FORMAT(//,' *** CO ARRAY AFTER WTPC51 ***')
      NTCO = 1+NRES*4
      WRITE(MESSAGESTRING,1611) (CO(J),J=1,NTCO)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
