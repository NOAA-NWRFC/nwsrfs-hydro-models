...
/**
* Module Name: getNumberOfInputTimeSeries()
* Original Author: Raymond.Chui@noaa.gov
* Module Creation Date: 10/9/2014
*
* Description:
*	Return the number of input time seires.
*
* Call Arguments:
*	None
*
...
*
*/
int getNumberOfInputTimeSeries()
{
	return numberOfInputTimeSeries;
} /* end of getNumberOfInputTimeSeries */
/*****************************************************************************
