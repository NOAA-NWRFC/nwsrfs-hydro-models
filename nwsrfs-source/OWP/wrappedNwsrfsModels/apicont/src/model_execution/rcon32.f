...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob90/ohd/ofs/src/fcst_ffg/RCS/rcon32.f,v $
     . $',                                                             '
...
!      CALL FPRBUG(SNAME,1,32,IBUG)
       IF (FEWSDEBUG.GT.3) THEN
         WRITE(MESSAGESTRING, *) 'Enter FFG - RCON32 -'
...
!      IF (IBUG.EQ.0) GO TO 110
      IF (FEWSDEBUG.EQ.0) GO TO 110
C
!      WRITE(IODBUG,900) LPR,LCR
      WRITE(MESSAGESTRING,900)LPR,LCR
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
call logfromfortran(DEBUG_LEVEL,MESSAGESTRING) 
...
!      WRITE(IODBUG,901) (PO(I),I=1,LPR)
      WRITE(MESSAGESTRING, 901)(PO(I),I=1,LPR)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING) 
  901 FORMAT(1H0,15F8.3)

!      WRITE(IODBUG,901) (CO(I),I=1,LCR)
      WRITE(MESSAGESTRING, 901) (CO(I),I=1,LCR)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
...
!      WRITE(IODBUG,921) IVOPT,IPRINT,IFRZE
      WRITE(MESSAGESTRING,921) IVOPT,IPRINT,IFRZE
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
  921 FORMAT(1H0,3I10)

!      WRITE(IODBUG,921) LSC,ITSC,LWE,ITWE,LTA,ITTA
      WRITE(MESSAGESTRING,922)LSC,ITSC,LWE,ITWE,LTA,ITTA 
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
  922 FORMAT(1H0,6I10)

!      WRITE(IODBUG,921) LFRZE,ITFI,ITFEI
      WRITE(MESSAGESTRING,921)LFRZE,ITFI,ITFEI
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING) 
C
C********************************
...
C*******************************
C
c 120 write(iodbug, *) 'EX24 - Start CO'
c     do i=1, 7
c       write(iodbug,*) co(i)
c     end do
 120  API  = CO(1)
