...
C
cCP    SUBROUTINE FRZE24(TA,LWE,WE,LSC,AESC,FINDX,FEI,AIR,DT,IBUG,IOUT)
      SUBROUTINE FRZE24(TA,LWE,WE,LSC,AESC,FINDX,FEI,AIR,DT)
C.......................................
...
C.......................................
C     DEBUG OUTPUT
cCP   195 IF (IBUG.EQ.0) GO TO 199
  195 IF (FEWSDEBUG.EQ.0) GO TO 199
cCP   WRITE (IOUT,900) FINDX1,FINDX,C,COVER,TA
      WRITE (MESSAGESTRING,900) FINDX1,FINDX,C,COVER,TA
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  900 FORMAT(1H ,5X,21HFROST INDEX--INITIAL=,F6.1,3X,6HFINAL=,F6.1,5X,
     15HCOEF=,F6.3,3X,6HCOVER=,F6.3,3X,3HTA=,F6.1)
C  
cCP   WRITE (IOUT,901) FEI,TWE,AIR,CTHAW
      WRITE (MESSAGESTRING,901) FEI,TWE,AIR,CTHAW
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
