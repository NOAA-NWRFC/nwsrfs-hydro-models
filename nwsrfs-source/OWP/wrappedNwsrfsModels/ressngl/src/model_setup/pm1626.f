...
C
      CONVMM = 1.0
!CP   IF (IMETEN.LE.0) CALL FCONVT('MM  ','L   ',UNITSE,CONVMM,CON,IER)
      IF (IMETEN.LE.0) CONVMM = 3.9370079E-02 !0.0032883
C
      DO 130 I=1,NEVAP
...
!CP   WRITE(IPR,1613) I1,I2,ELA(I1),ELA(I2),AEL(I1),AEL(I2),
      WRITE(MESSAGESTRING, 1613) I1,I2,ELA(I1),ELA(I2),
     &      AEL(I1),AEL(I2),ELS(I1),ELS(I2),ELS(I2+1), 
     &      SEL(I1),SEL(I2),SEL(I2+1),AEL(I1)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   WRITE(IPR,1615)
 ...
 1615 FORMAT(/'   ** ELEVATION VS. STORAGE VS MINIMUM STROAGE CURVE ')
      ...
      DO 1620 ISE=ISE6,NSE6
        I2=I1+5
!CP     WRITE(IPR,1621) (ELS(I),I=I1,I2)
!CP     WRITE(IPR,1622) (SEL(I),I=I1,I2)
!CP     WRITE(IPR,1623) (SELMN(I),I=I1,I2)
        WRITE(MESSAGESTRING, 1621) 
        call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
        WRITE(FORMATSTR, *) '%10.3f'
	call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,6,
     >       FORMATSTR,I1,I2,1,ELS)
        WRITE(MESSAGESTRING, 1622) 
        call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
        WRITE(FORMATSTR, *) '%10.1f'
	call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,6,
     >       FORMATSTR,I1,I2,1,SEL)
        WRITE(MESSAGESTRING, 1623)
        call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
        WRITE(FORMATSTR, *) '%10.1f'
        call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,6,
     >       FORMATSTR,I1,I2,1,SELMN)
        I1=I2
 1620 CONTINUE
      I1=I2+1
      I2=NSE
...
!CP   WRITE(IPR,1622) (SEL(I),I=I1,I2)
!CP   WRITE(IPR,1623) (SELMN(I),I=I1,I2)
      WRITE(MESSAGESTRING, 1621) !(ELS(I),I=I1,I2)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      WRITE(FORMATSTR, *) '%10.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,6,
     >     FORMATSTR,I1,I2,1,ELS)
