...
!CP   WRITE(IODBUG,40) NS2,FRAC1,FRAC2,SBGN,SFILL,SPILMX,STOCR,S1,S2,  Q
      WRITE(MESSAGESTRING, 40) NS2,FRAC1,FRAC2,SBGN,SFILL,SPILMX,STOCR,
     $S1,S2,QI1,QI2,QIM,QO1,QO2,QOM,QOK1,QOK2,QOKBGN,QOSBGN,TESTPK,
     $NTOTPK,IUNC,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C***********************************************************************
!CP   180 IF(IBUG.NE.2) GO TO 200
  180 IF ( FEWSDEBUG.LT.3 ) GO TO 200
!CP   WRITE(IODBUG,190) QQI1,QQI2,QQOK1,QQOK2,QOS1,QOS2,SS1,SS2
      WRITE(MESSAGESTRING, 190) QQI1,QQI2,QQOK1,QQOK2,QOS1,QOS2,SS1,SS2
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
cf      IF(TEST.LE.QO1.OR.TEST.LE.QO2) GO TO 290
  ...
  260 PKPOS(NUMPKO)=NS2+0.01
      GO TO 290
!CP   270 WRITE(IPR,280)NTOTPK,NUMPKO
  270 WRITE(MESSAGESTRING, 280) NTOTPK,NUMPKO
...
C WRITE TRACE AND DEBUG IF REQUIRED.
C***********************************************************************
!CP   290 IF(IBUG-1)370,350,300
!CP   300 WRITE(IODBUG,310)QO2,QOM,S2

  290 IF ( FEWSDEBUG.LT.4 ) GO TO 370
      WRITE(MESSAGESTRING, 310) QO2,QOM,S2
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  310 FORMAT(1H0,41H QO2,QOM, AND S2 AT THE END OF RUTE26 ARE,3F12.3)
   
      ROSTEP=FRAC2/STEPS
!CP   WRITE(IODBUG,320) ROSTEP
      WRITE(MESSAGESTRING, 320) ROSTEP
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  320 FORMAT(1H0,61H LENGTH OF ROUTING STEP AS A FRACTION OF THE TIME IN
     $TERVAL IS,F6.3)
  
!CP   WRITE(IODBUG,330) (O(I),WORK(I),SOH(I),I=1,NOSOH)
      WRITE(MESSAGESTRING, 330) (O(I),WORK(I),SOH(I),I=1,NOSOH)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   WRITE(IODBUG,340) PTEST,TESTPK,QO1,QO2
      WRITE(MESSAGESTRING, 340) PTEST,TESTPK,QO1,QO2
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
