...
!CP   1600 FORMAT('   *** ENTER XADI26 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,'(A23)') '   *** ENTER XADI26 ***'
...
!CP   1699 FORMAT('    *** EXIT XADI26 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,'(A23)') '    *** EXIT XADI26 ***'
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
C
      RETURN
