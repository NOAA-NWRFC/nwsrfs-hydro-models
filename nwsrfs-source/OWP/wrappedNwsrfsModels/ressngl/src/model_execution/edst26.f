...
!CP   WRITE(IODBUG,40) IFCST,FCST,NS2,NQMX24,NTIM24,KHRPRD,
      WRITE(MESSAGESTRING, 40) IFCST,FCST,NS2,NQMX24,NTIM24,KHRPRD,
...
C ......................................................................
!CP   210 IF (IBUG.LT.2) GO TO 215
  210 IF ( FEWSDEBUG.LT.3 ) GO TO 215
!CP   WRITE(IODBUG,220) IG,FCSTVA,CHANGE,JRELNO,M1,N1,NDSVA1,NDSUM,NPOS,
      WRITE(MESSAGESTRING, 220) IG,FCSTVA,CHANGE,JRELNO,M1,N1,NDSVA1,
     & NDSUM,NPOS,JBGN,JEND,JBGN1,JEND1,JBGN2,JEND2,QMAX
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   310 IF(IBUG-1) 520,500,320
  310 IF ( FEWSDEBUG.LT.4 ) GO TO 520
!CP   320 WRITE(IODBUG,330)
      WRITE(MESSAGESTRING, 330)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   IF(NQMX24.GT.0) WRITE(IODBUG,340) (TIME(I),FACTOR(I),I=1,NTIM24)
      IF (NQMX24.GT.0) THEN
         WRITE(MESSAGESTRING, 340) 
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  340    FORMAT(1H0,42H ALTERNATING VALUES OF TIME AND FACTOR ARE) 
         NPRINT=NTIM24
         IF ( NPRINT.GT. 100 ) NPRINT=100
         WRITE(FORMATSTR, *) '%6.3f'
         call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,2,4,
     >        FORMATSTR,1,NPRINT,1,TIME,FACTOR)
      END IF

      JBGN=1
      JEND=DNOVAL(1)+0.05
!CP   WRITE(IODBUG,390) (DSVALU(I),I=JBGN,JEND)
  ...
  390 FORMAT(1H0,' PREVIOUS AND CURRENT PERIOD VALUES FOR 1ST GAGE =')
      ...
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,2,
     >     FORMATSTR,JBGN,NPRINT,1,DSVALU)
      
cc390 FORMAT(1H0,110HFOLLOWING ARE OBSERVED OR FORECAST VALUES FOR FIRST
...
!CP   WRITE(IODBUG,400) (DSVALU(I),I=JBGN,JEND)
      WRITE(MESSAGESTRING, 400) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
cc400 FORMAT(1H0,107HFOLLOWING ARE OBSERVED OR FORECAST VALUES FOR SECON
cc   $D DOWNSTREAM GAGE EXCLUDING OUTFLOW FOR THIS TIME PERIOD/(1X,10F12
cc   $.3))
!CP   410 WRITE(IODBUG,420) (TIMLAG(I),I=1,NGAGES)
  410 WRITE(MESSAGESTRING, 420) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  420 FORMAT(1H0,' NO. OF TIME STEP LAG FROM DAM TO D/S GAGES =')
      NPRINT=NGAGES
      IF ( NPRINT.GT. 100 ) NPRINT=100
      WRITE(FORMATSTR, *) '%10.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,2, 
     >     FORMATSTR,1,NPRINT,1,TIMLAG)

cc420 FORMAT(1H0,110H LAG VALUES FOR GETTING FCST DOWNSTREAM GAGE VALUES
cc   $ FOR STAGE (OR DISCHARGE) VS PERMISSIBLE DISCHARGE RELATION/(1X,10
cc    $F12.3))
      JBGN=1
      JEND=ELVNO(1)+0.05
      DO 440 I=1,NELVNO
!CP   WRITE(IODBUG,430) I,(ELRES(J),RELNO(J),J=JBGN,JEND)
      WRITE(MESSAGESTRING, 430) I 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  430 FORMAT(1H0,65H ALTERNATING VALUES OF ELEVATION AND RELATION NUMBER
     ...
     >     FORMATSTR,JBGN,NPRINT,1,ELRES,RELNO)
  ...
  440 CONTINUE
      ...
      JEND=JBGN+JJ-1
!CP   WRITE(IODBUG,450)I,(RELATN(J),J=JBGN,JEND)
      WRITE(MESSAGESTRING, 450) I 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  450 FORMAT(1H0,59H DOWNSTREAM GAGE VALUES IN PERMISSIBLE OUTFLOW RELAT
     ...
     >     FORMATSTR,JBGN,NPRINT,1,RELATN)
!CP   WRITE(IODBUG,460)
      WRITE(MESSAGESTRING, 460)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  460 FORMAT(1H0,33H CORRESPONDING OUTFLOW VALUES ARE)
      ...
      NPRINT=JEND
      IF ( NPRINT.GT. 100 ) NPRINT=100
!CP   WRITE(IODBUG,470)  (RELATN(J),J=JBGN,JEND)
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,10,
     >     FORMATSTR,JBGN,NPRINT,1,RELATN)
      JBGN=JEND+1
...
CC490 FORMAT(1H0,9H IFLAG IS,I6,43H.  NO OF POINTS ON ELEV. - STORAGE CU
CC   $RVE IS,I4,1H./1H0,48H ALTERNATING VALUES OF STORAGE AND ELEVATION
CC   $ARE/(1X,5(F12.3,F9.3,3X)))
!CP   500 WRITE(IODBUG,510)
  500 WRITE(MESSAGESTRING, 510)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
