...
!CP   WRITE(IODBUG,40) FCST,NS2,IOPT,QIM,QO2,QOM,S1,S2,ELEV1,
      WRITE(MESSAGESTRING, 40) FCST,NS2,IOPT,QIM,QO2,QOM,S1,S2,ELEV1,
     $ELEV2,NTERP,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   140 IF(IBUG-1)230,210,150
!CP   150 WRITE(IODBUG,160)

  140 IF ( FEWSDEBUG.LT.4 ) GO TO 230
      WRITE(MESSAGESTRING, 160)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  160 FORMAT(1H0,45H VALUES AT THE END  OF PREL26 ARE AS FOLLOWS:)

!CP   WRITE(IODBUG,40) FCST,NS2,IOPT,QIM,QO2,QOM,S1,S2,ELEV1,ELEV2,
      WRITE(MESSAGESTRING, 40) FCST,NS2,IOPT,QIM,QO2,QOM,S1,S2,ELEV1,
     $ELEV2,NTERP,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
     
      IF(IOPT.EQ.0)GO TO 190
!CP   WRITE(IODBUG,170)(ELEVC(I),I=1,IOPT)
      WRITE(MESSAGESTRING, 170) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  170 FORMAT(1H0,43H BACK ELEVATIONS IN THE CARRYOVER ARRAY ARE)
      WRITE(FORMATSTR, *) '%12.3f' 
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,10,
     >     FORMATSTR,1,IOPT,1,ELEVC)

!CP   190 WRITE(IODBUG,200)IFLAG,NSE,(STOR(I),ELEV(I),I=1,NSE)
  190 WRITE(MESSAGESTRING, 200)IFLAG,NSE !,(STOR(I),ELEV(I),I=1,NSE)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
