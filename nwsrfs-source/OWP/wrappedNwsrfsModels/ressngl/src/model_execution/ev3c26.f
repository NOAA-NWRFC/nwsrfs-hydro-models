...
!CP   call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
!CP   GO TO 50
!CP   20 WRITE(IODBUG,30)
!CP   20 WRITE(MESSAGESTRING, 30)
...
!CP   WRITE(IODBUG,40) IOUT,IOPTEV,HTARG3,DIFQI2,QTARG3,REDUC1,REDUC2,
      WRITE(MESSAGESTRING, 40) IOUT,IOPTEV,HTARG3,DIFQI2,QTARG3,REDUC1,
     & REDUC2,FRPD,SFRPD,QIMSUR,QQIM,QQO1,QQO2,SS1,SS2,ELRES1,ELRES2,
     & RULEL1,RULEL2,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C WRITE TRACE AND DEBUG IF REQUIRED.
C
!CP 80   IF(IBUG-1)140,120,90
!CP   90 WRITE(IODBUG,100)

 80   IF ( FEWSDEBUG.LT.4 ) GO TO 140
...
!CP   WRITE(IODBUG,110)(STOR(I),ELEV(I),I=1,NSE)
      WRITE(MESSAGESTRING, 110) !(STOR(I),ELEV(I),I=1,NSE)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
