...
C
     ...
     .     QMD(NUMDAY),LOCTSI(7),QWORK(NUMDAY),IERD(NUMDAY)
c bug 280     .          QMD(31),LOCTSI(7),QWORK(31),IERD(31)
...
C
!CP   IF (IBUG.GE.1) WRITE(IODBUG,6600)
!CP   6600 FORMAT('   *** ENTER XU1726 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,'(A23)') '   *** ENTER XU1726 ***'
...
C
   50 CONTINUE
      LOCBTS = LOCBTS + IADD
  100 CONTINUE
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1613) LOCTSI
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, 1613) LOCTSI
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
...
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1615) WRAJQI,IDTAJI,LADJQI,WRAJQM,
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, 1615) WRAJQI,IDTAJI,LADJQI,WRAJQM,
...
C
      IF (DORAIN) GO TO 280
C
C      LOCAQM = LOCOWS(1) + NDD*NTIM24
      LOCAQM = LOCOWS(1) + NTIMESTEPS
      DO 270 I=1,NRUN
...
C
      LOCQO = LOCWS(2)
C      LOCQOM = LOCQO + NDD*NTIM24
      LOCQOM = LOCQO + NTIMESTEPS
C      LOCEL = LOCQOM + NDD*NTIM24
      LOCEL = LOCQOM + NTIMESTEPS
C      LOCSTO = LOCEL + NDD*NTIM24
      LOCSTO = LOCEL + NTIMESTEPS
C
      LAINST = 0
C
...
C
      ...
      NDAY = NRUN/NTIM24
      NOBS = NDAY*NTIMOB
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1620)
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1650) (D(LOBSQM+I-1),I=1,NOBS)
      IF ( FEWSDEBUG.GE.4 ) THEN
         print *,'NOBS = ',NOBS
         NPRINT=NOBS
 ...
 1620    FORMAT(/10X,'** OBSERVED MEAN DISCHARGES **')
     ...
     >        FORMATSTR,LOBSQM,LOBSQM+NPRINT-1,1,D)
      END IF
C
C
...
C
 2500 CONTINUE
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1620)
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1650) (D(LOBSQM+I-1),I=1,NRUN)
      IF ( FEWSDEBUG.GE.4 ) THEN
         NPRINT=NRUN
	 IF ( NPRINT.GT.100 ) NPRINT=100
         WRITE(MESSAGESTRING, 1620)
...
C
      ...
      NPVAL = NRUN/NINT
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1610)
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1651) (D(LOBSEL+I-1),I=1,NPVAL)
      IF ( FEWSDEBUG.GE.4 ) THEN
         NPRINT=NPVAL
         IF ( NPRINT.GT.100 ) NPRINT=100
 ...
 1610    FORMAT(/10X,'** OBSERVED POOL ELEVATIONS **')
	 ...
	 call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,8,
     >        FORMATSTR,LOBSEL,LOBSEL+NPRINT-1,1,D)
...
!CP   IF (IBUG.LE.1) GO TO 6002
!CP   WRITE(IODBUG,1610)
      IF ( FEWSDEBUG.LT.4 ) GO TO 6002
      WRITE(MESSAGESTRING, 1610)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
!CP   WRITE(IODBUG,1651) (D(LOBSEL+I-1),I=1,NPVAL)
      NPRINT=NPVAL
      IF ( NPRINT.GT.100 ) NPRINT=100
      WRITE(FORMATSTR, *) '%10.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,8,
...
!CP   WRITE(IODBUG,1620)
      WRITE(MESSAGESTRING,1620)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
!CP   WRITE(IODBUG,1650) (D(LOBSQM+I-1),I=1,NRUN)
      NPRINT=NRUN
      IF ( NPRINT.GT.100 ) NPRINT=100
      WRITE(FORMATSTR,*) '%10.0f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,8,
...
C
 6500 CONTINUE
      ...
      NOBS = NDAY*NTIMOB
      NPVAL = NRUN*MINODT/IDTEL
!CP   IF (IBUG.LE.1) GO TO 6502
!CP   WRITE(IODBUG,1610)
      IF ( FEWSDEBUG.LT.4 ) GO TO 6502
      WRITE(MESSAGESTRING, 1610)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
!CP   WRITE(IODBUG,1651) (D(LOBSEL+I-1),I=1,NPVAL)
      NPRINT=NPVAL
...
!CP   WRITE(IODBUG,1620)
      WRITE(MESSAGESTRING,1620)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
!CP   WRITE(IODBUG,1650) (D(LOBSQM+I-1),I=1,NOBS)
      NPRINT=NOBS
      IF ( NPRINT.GT.100 ) NPRINT=100
      WRITE(FORMATSTR,*) '%10.0f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,8,
...
!CP      IF (IERNVI.NE.0) WRITE(IPR,675) (IERPDI(I),I=1,IERNVI)
      IF (IERNVI.NE.0) THEN
         WRITE(MESSAGESTRING, 675) (IERPDI(I),I=1,IERNVI)
         call logfromfortran(WARNING_LEVEL, MESSAGESTRING)
!CP   IF (IERNVI.NE.0) CALL WARN
...
!CP   IF (IERNVM.NE.0) WRITE(IPR,680) (IERPDM(I),I=1,IERNVM)
      IF (IERNVM.NE.0) THEN
         WRITE(MESSAGESTRING, 680) (IERPDM(I),I=1,IERNVM)
         call logfromfortran(WARNING_LEVEL, MESSAGESTRING)
      END IF
!CP   IF (IERNVM.NE.0) CALL WARN
...
C
!CP   IF (IBUG.LT.2) GO TO 9009
      IF ( FEWSDEBUG.LT.4 ) GO TO 9009
      NPRINT=NUM
      IF ( NPRINT.GT.100 ) NPRINT=100
C
C  WRITE INST. ADJ. DISCHARGES
C
!CP   WRITE(IODBUG,1690)
      WRITE(MESSAGESTRING, 1690)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1690 FORMAT(/10X,'** INST. ADJ. DISCHARGES **')

!CP   WRITE(IODBUG,1650) (W(LOCQO+I-1),I=1,NUM)
      WRITE(MESSAGESTRING,1650) (W(LOCQO+I-1),I=1,NPRINT)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
c     NPRINT=NUM
c     IF ( NPRINT.GT.100 ) NPRINT=100
c     WRITE(FORMATSTR,*) '%10.0f'
c     call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,8,
c    >     FORMATSTR,LOCQO,LOCQO+NPRINT-1,1,W)
...
C
!CP   WRITE(IODBUG,1692)
      WRITE(MESSAGESTRING, 1692)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1692 FORMAT(/10X,'** MEAN ADJ. DISCHARGES **')
 
!CP   WRITE(IODBUG,1650) (W(LOCQOM+I-1),I=1,NUM)
      WRITE(MESSAGESTRING,1650) (W(LOCQOM+I-1),I=1,NPRINT)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
c     WRITE(FORMATSTR,*) '%10.0f'
c     call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,8,
c    >     FORMATSTR,LOCQOM,LOCQOM+NPRINT-1,1,W)
      
C
C  WRITE ADJ. POOL ELEVATIONS
C
!CP   WRITE(IODBUG,1694)
      WRITE(MESSAGESTRING, 1694)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1694 FORMAT(/10X,'** ADJ. POOL ELEVATIONS **')
 
!CP   WRITE(IODBUG,1651) (W(LOCEL+I-1),I=1,NUM)
      WRITE(MESSAGESTRING,1651) (W(LOCEL+I-1),I=1,NPRINT)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
c     WRITE(FORMATSTR,*) '%10.3f'
c     call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,8,
c    >     FORMATSTR,LOCEL,LOCEL+NPRINT-1,1,W) 
      
C
C  WRITE ADJ. STORAGES
C
!CP   WRITE(IODBUG,1696)
      WRITE(MESSAGESTRING, 1696)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1696 FORMAT(/10X,'** ADJ. STORAGES **')
 
!CP   WRITE(IODBUG,1650) (W(LOCSTO+I-1),I=1,NUM)
      WRITE(MESSAGESTRING,1650) (W(LOCSTO+I-1),I=1,NPRINT)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
c     WRITE(FORMATSTR,*) '%10.0f'
c     call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,8,
c    >     FORMATSTR,LOCSTO,LOCSTO+NPRINT-1,1,W)  
        
C
!CP   WRITE(IODBUG,1680) NRUNS,LOBSTO,ICOMB
      WRITE(MESSAGESTRING, 1680) NRUNS,LOBSTO,ICOMB
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   1699 FORMAT('    *** EXIT XU1726 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,'(A23)') '    *** EXIT XU1726 ***'
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
      END IF
C
      RETURN
