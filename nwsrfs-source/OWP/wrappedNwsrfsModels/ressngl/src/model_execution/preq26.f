...
!CP   WRITE(IODBUG,40)IFCST,FCST,NS2,IOPT,IQO,QI2,QIM,QO1,QO2,QOM,S1,S2,
      WRITE(MESSAGESTRING, 40)IFCST,FCST,NS2,IOPT,IQO,QI2,QIM,QO1,QO2,
     $QOM,S1,S2,ELEV2,NTERP,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
