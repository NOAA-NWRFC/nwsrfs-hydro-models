...
!CP   WRITE(IODBUG,40) IFCST,FCST,QI1,QI2,QIM,QO1,QO2,QOM,S1,S2,
      WRITE(MESSAGESTRING, 40) IFCST,FCST,QI1,QI2,QIM,QO1,QO2,QOM,S1,S2,
...
C ......................................................................
      SFRAC=SFRAC+FRAC
      SQOM=SQOM+QO*FRAC
!CP   IF(IBUG.NE.2) GO TO 160
      IF ( FEWSDEBUG.LT.3 ) GO TO 160
!CP   WRITE(IODBUG,150) DIFQI,QI,QO,SS1,K,STORAG(K),FRAC,SFRAC,SQOM
      WRITE(MESSAGESTRING, 150) DIFQI,QI,QO,SS1,K,STORAG(K),FRAC,
     $ SFRAC,SQOM
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C ......................................................................
  ...
  250 IRISE=0
      IF(S2 .GT. S1) IRISE=1
!CP   IF(IBUG-1)320,300,260
!CP   260 WRITE(IODBUG,270) QO2, QOM, S2, ELEV2, IRISE

      IF ( FEWSDEBUG.LT.4 ) GO TO 320
      WRITE(MESSAGESTRING, 270) QO2, QOM, S2, ELEV2, IRISE
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C     $ARE/(1X,10F12.3))
!CP   WRITE(IODBUG,290)(ELVOUT(I),STORAG(I),OUTFLO(I),I=1,NSO)
      WRITE(MESSAGESTRING, 290) !(ELVOUT(I),STORAG(I),OUTFLO(I),I=1,NSO)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  290 FORMAT(1H0,118HFOLLOWING ARE SETS OF ELEVATION, CORRESPONDING STOR
     ...
     >     FORMATSTR,1,NSO,1,ELVOUT,STORAG,OUTFLO)
      

!CP  300 WRITE(IODBUG,310)
      WRITE(MESSAGESTRING, 310)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
