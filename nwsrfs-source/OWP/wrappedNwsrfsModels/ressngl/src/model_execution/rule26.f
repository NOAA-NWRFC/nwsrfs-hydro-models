...
!CP   WRITE(IODBUG,40)IFCST,FCST,NS2,LOBSTO,NTIMES,AGBDEV,AVGDEV,QLIMRL,
      WRITE(MESSAGESTRING, 40)IFCST,FCST,NS2,LOBSTO,NTIMES,AGBDEV,
     $AVGDEV,QLIMRL,QIM,QO2,QOM,S1,S2,ELEV2,NTERP,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   130 IF (IBUG-1)190,170,140
  130 IF ( FEWSDEBUG.LT.4 ) GO TO 190
      RULEL1=BGNRCE
