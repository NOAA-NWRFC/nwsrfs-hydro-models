...
C     LOBSTOO -- POSITION IN THE STORAGE ARRAY OF THE LAST OBSERVED
...
C ......................................................................
      ITBUG=IBUG
      IF ( FEWSDEBUG.GE.5 ) IBUG=1
      IF ( FEWSDEBUG.LT.4 ) GO TO 50
      WRITE(MESSAGESTRING, 30)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
   30 FORMAT(1H0,10X,17H** QMIN26 ENTERED)
   
!CP   WRITE(IODBUG,40) IFCST,NRUN,NUM,IOPTR,IOPTM,IOPTF,NPERDR,NPERDF,
      WRITE(MESSAGESTRING,40) IFCST,NRUN,NUM,IOPTR,IOPTM,IOPTF,NPERDR,
     $NPERDF,LOBSTO,BGNQI,BGNQO,BGNSTO,EUPRMN,ELWRMN,EMXSTO,PCTERM,
     $QLIMNF,QFLOOD,ELVNRM,NTERPQ,NTERP,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
Chsu    LOBSTO=0
        IF(NS2.LE.LOBSTO) LOBSTO=0 !CP if endTimeMod > T0/obstime
        GO TO 110
      ENDIF
C ......................................................................
...
C ......................................................................
Chsu  210 IF(ESTQMX.EQ.OUT) GO TO 410
  210 IF(ABS(ESTQMX-OUT).LE.0.1) GO TO 410
...
C ......................................................................
      ...
      PRFQOM=FQOM
      GO TO 370
Chsu  350 IF(ESTQMX.EQ.PREQMX) ESTQMX=PREQMX+0.001
  350 IF(ABS(ESTQMX-PREQMX).LE.0.1) ESTQMX=PREQMX+0.001
...
C ......................................................................
  ...
  360 ESTQMX=ESTQMX+DIFQMX
      GO TO 410
!CP   370 IF(IBUG.NE.2.OR.II.EQ.1) GO TO 400
  370 IF (FEWSDEBUG.LT.3.OR.II.EQ.1) GO TO 400
!CP   IF(IOPTR.EQ.2) WRITE(IODBUG,380) NP,FRACR,FRACRN
      IF(IOPTR.EQ.2) THEN
        WRITE(MESSAGESTRING, 380) NP,FRACR,FRACRN
	call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  380   FORMAT(1X,16H NP,FRACR,FRACRN/1X,I6,2F12.3)
      END IF
!CP   WRITE(IODBUG,390) II,NPOS,LOBSTO,IOPTR,PCTERM,
      WRITE(MESSAGESTRING, 390) II,NPOS,LOBSTO,IOPTR,PCTERM,
  ...
  400 CONTINUE
!CP   410 IF(IBUG.NE.2) GO TO 420
  410 IF ( FEWSDEBUG.LT.3 ) GO TO 420
!CP   WRITE(IODBUG,390) II,NPOS,LOBSTO,IOPTR,PCTERM,
      WRITE(MESSAGESTRING, 390) II,NPOS,LOBSTO,IOPTR,PCTERM,
     & DIFSTO,FRAC,FRACIN,SUMIN,SUMOUT,PREQMX,ESTQMX,FQOM,DIFQMX
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C
  420 SAVQMX=ESTQMX
      ...
      IF(.NOT.(ESTQMX.GT.QLIMNF.AND.ESTQMX.LT.QFLOOD)) THEN
        GO TO 510
      ENDIF
...
C ......................................................................
!CP   IF(IBUG.NE.2) GO TO 650
      IF ( FEWSDEBUG.LT.3 ) GO TO 650
!CP   WRITE(IODBUG,630) JBGN,NPOS,ESTQMX,(QOMHYD(I),I=JBGN,NPOS)
      WRITE(MESSAGESTRING, 630) JBGN,NPOS,ESTQMX 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  630 FORMAT(1H0,44H    JBGN,NPOS,ESTQMX,(QOMHYD(I),I=JBGN,NPOS)/1X,2I6,
     $F12.3)
      ...
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,JBGN,NPRINT,1,QOMHYD)

!CP   WRITE(IODBUG,640) (QOHYD(I),I=JBGN,NPOS)
      WRITE(MESSAGESTRING, 640) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  640 FORMAT(1H0,   23H (QOHYD(I),I=JBGN,NPOS)) 
      WRITE(FORMATSTR, *) '%12.3f' 
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,JBGN,NPRINT,1,QOHYD)
...
C
  720 IF(ABS(SAVQMX-ESTQMX).LE.0.1) GO TO 750
...
!CP   IF(IBUG.NE.2) GO TO 750
      IF ( FEWSDEBUG.LT.3 ) GO TO 750
!CP   WRITE(IODBUG,740) IOPTR,IOPTM,IOPTF,SAVQMX,ESTQMX,FRAC,VOLUM,
      WRITE(MESSAGESTRING, 740) IOPTR,IOPTM,IOPTF,SAVQMX,ESTQMX,FRAC,
     $VOLUM,SUMOUT,DIFVOL
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C ......................................................................
      ...
      QO2=QI2
      IF(QI2.LE.QMX.AND.QMX.LT.QLIMNF) THEN 
        QO2=QMX
        GO TO 799
      ENDIF
      IF(QO2.LE.QLIMNF) QO2=QLIMNF
  799 QOM=QO1*FRACF+(QO1+QO2)*0.5*(1.-FRACF)
      GO TO 810
  800 QO2=QI2
      IF(QI2.LE.QMX.AND.QMX.LT.QLIMNF) THEN 
        QO2=QMX
...
!CP   910 IF(IBUG.NE.2) GO TO 930
  910 IF ( FEWSDEBUG.LT.3 ) GO TO 930
!CP   WRITE(IODBUG,920) J,NPOS,QIJ,SQIMJ,SUMQIM,SUMQOM,SJ1,SJ2,STORUL
      WRITE(MESSAGESTRING, 920) J,NPOS,QIJ,SQIMJ,SUMQIM,SUMQOM,
     $                          SJ1,SJ2,STORUL
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  920 FORMAT(1H0,   46H J,NPOS,QIJ,SQIMJ,SUMQIM,SUMQOM,SJ1,SJ2,STORUL/1X
     $,2I6,7F12.3)
  930 IF(KEND.NE.J) GO TO 950
!CP   IF(IBUG.NE.2) GO TO 960
      IF ( FEWSDEBUG.LT.3 ) GO TO 960
!CP   WRITE(IODBUG,940) FRACKN
      WRITE(MESSAGESTRING, 940) FRACKN
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   IF(IBUG.NE.2) GO TO 1210
!CP   WRITE(IODBUG,1200) NSTEPS,FRAC2,(TOTLQ(J),WORK(J),J=1,NTOTLQ)
      IF ( FEWSDEBUG.LT.3 ) GO TO 1210
      WRITE(MESSAGESTRING,1200) NSTEPS,FRAC2,
     $                          (TOTLQ(J),WORK(J),J=1,NTOTLQ)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP 1250 IF(IBUG.NE.2) GO TO 1270
 1250 IF ( FEWSDEBUG.LT.3 ) GO TO 1270
C
C WRITE DEBUG IF REQUIRED.
C
!CP   WRITE(IODBUG,1260) QQI1,QQI2,QQO1,QQO2,SS1,SS2
      WRITE(MESSAGESTRING, 1260) QQI1,QQI2,QQO1,QQO2,SS1,SS2
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C
 ...
 1300 PKPOS(NUMPKO)=I + 0.01
      GO TO 1330
!CP   1310 WRITE(IPR,1320) NTOTPK,NUMPKO
 1310 WRITE(MESSAGESTRING, 1320) NTOTPK,NUMPKO
...
cHSU  IF(QOMADJ.EQ.QOM) GO TO 1420
      IF(ABS(QOMADJ-QOM).LE.0.1) GO TO 1420
      IF(QOMADJ.LT.QOM) QOM=QO2
      PERIDS=NPOS-I
      PERIDS=PERIDS+FRAC
C
...
Chsu  IF(ADJUST.EQ.0.) GO TO 1420
      IF(ABS(ADJUST).LE.0.1) GO TO 1420
      QIHYD1=QIHYD(NPOS)
...
C
 1420 IF(IFCST.EQ.0) GO TO 1422  !this case never happen
      IF(I.GT.NRUN) GO TO 1422
      QO22=OBSQO(I)
      QOMM=OBSQOM(I)
      IF(QO22.LE.-999.0.AND.QOMM.LE.-999.0) GO TO 1422
 ...
 1422 CONTINUE 
      ...
      STOHYD(I)=S2
      QOMHYD(I)=QOM
!CP   IF(IBUG.NE.2) GO TO 1490
      IF ( FEWSDEBUG.LT.3 ) GO TO 1490
      IF(I.LE.NPOS) GO TO 1440
!CP   WRITE(IODBUG,1430) I,QO1,QO2,QOM,QI1,QI2,QIM,S1,S2,ELEV1,ELEV2
      WRITE(MESSAGESTRING, 1430) I,QO1,QO2,QOM,QI1,QI2,QIM,S1,S2,
     $                           ELEV1,ELEV2
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1430 FORMAT(1H0,   44H I,QO1,QO2,QOM,QI1,QI2,QIM,S1,S2,ELEV1,ELEV2/1X,
     $I6,9F12.3/1X,F12.3)
      ...
      GO TO 1490
C=======================================================
!CP   1440 IF(IOPTM.EQ.2) WRITE(IODBUG,1450) DIFVOL
 1440 IF(IOPTM.EQ.2) THEN
         WRITE(MESSAGESTRING, 1450) DIFVOL
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
 1450 FORMAT(1H0, 8H DIFVOL=,F12.3)
      IF(QMAX2.GE.QO2) GO TO 1470

!CP   WRITE(IODBUG,1460) I,NPOS,NSTEPS,QO1,QQO1,QO2,QQO2,QOM,QI1,QQI1,
      WRITE(MESSAGESTRING, 1460) I,NPOS,NSTEPS,QO1,QQO1,QO2,QQO2,QOM,QI1
     $ ,QQI1,QI2,QQI2,QIM,S1,S2,ELEV1,ELEV2,QMAX1,QMAX2,FRAC1,FRAC2,
     $ ADJUST,ESTQMX,QMX,QOMADJ
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   1470 WRITE(IODBUG,1480)I,NPOS,QO1,QO2,QOM,QI1,QI2,QIM,S1,S2,
!CP   ELEV1,ELEV2
 1470 WRITE(MESSAGESTRING, 1480)I,NPOS,QO1,QO2,QOM,QI1,QI2,QIM,S1,S2,
     $ELEV1,ELEV2,QMAX2,ADJUST,ESTQMX,QMX,QOMADJ
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   IF(IBUG-1) 1660,1640,1500
!CP 1500 WRITE(IODBUG,1510)

      IF ( FEWSDEBUG.LT.4 ) GO TO 1660
      WRITE(MESSAGESTRING, 1510)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   WRITE(IODBUG,40) IFCST,NRUN,NUM,IOPTR,IOPTM,IOPTF,NPERDR,NPERDF,
     ...
     $QLIMNF,QFLOOD,ELVNRM,NTERPQ,NTERP,IBUG
      ...
      NPRINT=NRUN
      IF ( NPRINT.GT.100 ) NPRINT=100
!CP   WRITE(IODBUG,1520) (OBSQO(I),I=1,NRUN)
      WRITE(MESSAGESTRING, 1520) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1520 FORMAT(1H0,36H OBSERVED INSTANTANEOUS OUTFLOWS ARE) 
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,1,NPOBS,1,OBSQO)

!CP   WRITE(IODBUG,1530) (OBSQOM(I),I=1,NRUN)
      WRITE(MESSAGESTRING, 1530) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1530 FORMAT(1H0,27H OBSERVED MEAN OUTFLOWS ARE) 
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,1,NPOBS,1,OBSQOM)

      NPRINT=NUM
      IF ( NPRINT.GT.100 ) NPRINT=100
!CP   WRITE(IODBUG,1550) (QIHYD(I),I=1,NUM)
      WRITE(MESSAGESTRING, 1550) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1550 FORMAT(1H0,41H VALUES IN INSTANTANEOUS INFLOW ARRAY ARE) 
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,1,NPRINT,1,QIHYD)

!CP   WRITE(IODBUG,1560) (QIMHYD(I),I=1,NUM)
      WRITE(MESSAGESTRING, 1560) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1560 FORMAT(1H0,32H VALUES IN MEAN INFLOW ARRAY ARE) 
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,1,NPRINT,1,QIMHYD)

!CP   WRITE(IODBUG,1570) (QOHYD(I),I=1,NUM)
      WRITE(MESSAGESTRING, 1570) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1570 FORMAT(1H0,42H VALUES IN INSTANTANEOUS OUTFLOW ARRAY ARE) 
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,1,NPRINT,1,QOHYD)

!CP   WRITE(IODBUG,1580) (QOMHYD(I),I=1,NUM)
      WRITE(MESSAGESTRING, 1580)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1580 FORMAT(1H0,33H VALUES IN MEAN OUTFLOW ARRAY ARE) 
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,1,NPRINT,1,QOMHYD)

!CP   WRITE(IODBUG,1590) (ELVHYD(I),STOHYD(I),I=1,NUM)
      WRITE(MESSAGESTRING, 1590) !(ELVHYD(I),STOHYD(I),I=1,NUM)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1590 FORMAT(1H0,54H ALTERNATING ARRAY VALUES OF ELEVATION AND STORAGE A
     $RE) !/(1X,10F12.3))
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,2,5,
     >     FORMATSTR,1,NPRINT,1,ELVHYD,STOHYD)

!CP   WRITE(IODBUG,1600) NDAMQ,(ELEVQ(I),DAMQ(I),I=1,NDAMQ)
      NPRINT=NDAMQ
      IF ( NPRINT.GT.100 ) NPRINT=100
      WRITE(MESSAGESTRING, 1600) NDAMQ !,(ELEVQ(I),DAMQ(I),I=1,NDAMQ)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1600 FORMAT(1H0,57H NO. OF POINTS ON ELEVATION VS MAXIMUM DISCHARGE CUR
     ...
     $ISCHARGE ARE) !/(1X,10F12.3))
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,2,5,
     >     FORMATSTR,1,NPRINT,1,ELEVQ,DAMQ)

!CP   WRITE(IODBUG,1610)IFLAG,NSE,(STOR(I),ELEV(I),I=1,NSE)
      NPRINT=NSE
      IF ( NPRINT.GT.100 ) NPRINT=100
      WRITE(MESSAGESTRING, 1610)IFLAG,NSE !,(STOR(I),ELEV(I),I=1,NSE)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   WRITE(IODBUG,1620) NTOTPK,(PEAKO(I),I=1,NUMPKO)
      NPRINT=NUMPKO
      IF ( NPRINT.GT.100 ) NPRINT=100
      WRITE(MESSAGESTRING, 1620) NTOTPK 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1620 FORMAT(1H0,52H TOTAL NO. OF POSITIONS AVAILABLE FOR PEAK VALUES IS
     $,I6,18H.  PEAK VALUES ARE) 
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,1,NPRINT,1,PEAKO)

!CP   WRITE(IODBUG,1630) (PKPOS(I),I=1,NUMPKO)
 ...
 1630 FORMAT(1H0,55H POSITIONS IN OUTFLOW ARRAY FOR PLACING PEAK VALUES
     $ARE) 
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLLINE,1,10,
     >     FORMATSTR,1,NPRINT,1,PKPOS)

!CP   1640 WRITE(IODBUG,1650)
 1640 WRITE(MESSAGESTRING, 1650)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
