...
C
!CP   IF(IBUG-1)60,20,30
!CP   20 WRITE(IODBUG,40)
!CP   GO TO 60
!CP   30 WRITE(IODBUG,40)
      IF ( FEWSDEBUG.LT.4 ) GO TO 60
      WRITE(MESSAGESTRING, 40)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
   40 FORMAT(1H0,10X,17H** FLSH26 ENTERED)

!CP   WRITE(IODBUG,50) IFCST,FCST,GOFLSH,BGNGAT,GATMAX,NS2,NUMLG,NUMSM,
      WRITE(MESSAGESTRING, 50) 
     $IFCST,FCST,GOFLSH,BGNGAT,GATMAX,NS2,NUMLG,NUMSM,
   ...
   50 FORMAT('(1H0,114H   IFCST,FCST,GOFLSH,BGNGAT,GATMAX,NS2,NUMLG,NUMSM,
     ...
     $,I6,2L5,2F12.3,7I6,3F12.3/1X,5F12.3/1H0,84HQOK1,QOK2,S1,S2,ELEV1,
...
C
      ...
      IF(GOFLSH) GO TO 60
!CP   IF(IBUG.NE.2) GO TO 1080
!CP   WRITE(IODBUG,51)
      IF ( FEWSDEBUG.LT.3 ) GO TO 1080 
      WRITE(MESSAGESTRING, 51)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C
  ...
  181 CONTINUE
!CP   182 IF(IBUG.NE.2) GO TO 184
!CP   WRITE(IODBUG,183) QMAX1,PREVQ2,QMAX2,S1,STOEND,ELEV1,ELV2,I181
  182 IF ( FEWSDEBUG.LT.3 ) GO TO 184
      WRITE(MESSAGESTRING, 183) QMAX1,PREVQ2,QMAX2,S1,STOEND,
     $                          ELEV1,ELV2,I181
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   290 WRITE(IPR,300) SS1,SS2,SIGSTO(K)
  290 WRITE(MESSAGESTRING, 300) SS1,SS2,SIGSTO(K)
...
C
!CP   330 IF(IBUG.NE.2) GO TO 740
!CP   340 WRITE(IODBUG,350) K,SS1,SS2
  330 IF ( FEWSDEBUG.LT.3 ) GO TO 740
      WRITE(MESSAGESTRING, 350) K,SS1,SS2
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C
  740 QQI1=QQI2
      ...
      PTEST=QQO1
      FRACPK=AI/STEPS
!CP   IF(IBUG.NE.2) GO TO 760
!CP   WRITE(IODBUG,750)QQI2,QQOK2,QQO2,SS2,SUMFRA,PTEST,FRACPK
      IF ( FEWSDEBUG.LT.3 ) GO TO 760
      WRITE(MESSAGESTRING, 750)QQI2,QQOK2,QQO2,SS2,SUMFRA,PTEST,FRACPK
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C
  ...
  790 PKPOS(NUMPKO)=NS2+0.01
      GO TO 820
!CP   800 WRITE(IPR,810) NTOTPK,NUMPKO
  800 WRITE(MESSAGESTRING, 810) NTOTPK,NUMPKO
      call logfromfortran(WARNING_LEVEL, MESSAGESTRING)
...
C WRITE TRACE AND DEBUG IF REQUIRED.
C
!CP   864 IF(IBUG-1) 1080,1060,870
  864 IF ( FEWSDEBUG.LT.4 ) GO TO 1080
!CP   870 WRITE(IODBUG,880)
      WRITE(MESSAGESTRING, 880)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  880 FORMAT(1H0,60H VALUES OF VARIABLES AT THE END OF FLSH26 ARE AS
     $FOLLOWS:)
  
      WRITE(MESSAGESTRING, 50) IFCST,FCST,GOFLSH,BGNGAT,GATMAX,
     $NS2,NUMLG,NUMSM,
     $NLGDN,NSMDN,NGATE,NFUTUR,COEF,DISTLG,DISTSM,QI1,QI2,QO1,QO2,QOM,
     $QOK1,QOK2,S1,S2,ELEV1,ELEV2,TESTPK,NTOTPK,NOSTEP,NLGSOH,NSMSOH,
     $NGASOH,NPOSOH,NTERPQ,QGENMX,SLUICE,PCTERF,NUM,NTERP,IBUG
      ...
      WRITE(MESSAGESTRING, 890) !(SIGELV(I),SIGSTO(I),I=1,NSIGEL)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  890 FORMAT (1H0,82H ALTERNATING VALUES OF SIGNIFICANT ELEVATIONS
     ...
     >     FORMATSTR,1,NPRINT,1,SIGELV,SIGSTO)
      
      WRITE(MESSAGESTRING, 900) !(SIGFAL(I),I=1,NFAL)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
  900 FORMAT(1H0,83H POSITION NUMBERS IN SIGELV ARRAY OF SIGNIFICANT
     $ELEVATIONS FOR FALLING POOL ARE) !/(1X,20I5))
      ...
      IF ( NPRINT.GT.100 ) NPRINT=100
      WRITE(FORMATSTR, *) '%5d'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,20,
     >     FORMATSTR,1,NPRINT,1,SIGFAL)
      
   
      WRITE(MESSAGESTRING, 910) !(SIGRIS(I),I=1,NRIS)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  910 FORMAT(1H0,82H POSITION NUMBERS IN SIGELV ARRAY OF SIGNIFICANT
     $ELEVATIONS FOR RISING POOL ARE) !/(1X,20I5))
      ...
      WRITE(FORMATSTR, *) '%5d'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,20,
     >     FORMATSTR,1,NPRINT,1,SIGRIS)
      

      IF(NGATE.EQ.-999) GO TO 930
      JEND=NS2+NFUTUR-1
!CP   WRITE(IODBUG,920)(QIMHYD(I),I=NS2,JEND)
      WRITE(MESSAGESTRING, 920) !(QIMHYD(I),I=NS2,JEND)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
  920 FORMAT(1H0,103HFUTURE MEAN TIME INTERVAL INFLOWS INCLUDING PRESENT
     ...
     >     FORMATSTR,NS2,NPRINT,1,QIMHYD) 
      

  930 IF(NUMPKO.EQ.-999) GO TO 950
!CP   WRITE(IODBUG,940)(PEAKO(I),PKPOS(I),I=1,NUMPKO)
      WRITE(MESSAGESTRING, 940) !(PEAKO(I),PKPOS(I),I=1,NUMPKO)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
  940 FORMAT(1H0,111HALTERNATING VALUES OF PEAK DISCHARGES BETWEEN
     ...
     >     FORMATSTR,1,NPRINT,1,PEAKO,PKPOS)
      
   
!CP   950 WRITE(IODBUG,960)(ELVSOH(I),STOSOH(I),I=1,NELSOH)
 950  WRITE(MESSAGESTRING, 960) !(ELVSOH(I),STOSOH(I),I=1,NELSOH)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
 960  FORMAT(1H0,107HALTERNATING VALUES OF ELEVATIONS FOR USE IN DEVELOP
     ...
     $ MEAN DISCHARGE FOR ROUTING STEP ARE) !/(1X,10F12.3))
      ...
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,2,5,
     >     FORMATSTR,1,NPRINT,1,ELVSOH,STOSOH)
      

      IF(FCST) GO TO 962
      IF(NGATE.EQ.-999) GO TO 962
!CP   WRITE(IODBUG,961) GATOP2
      WRITE(MESSAGESTRING, 961) GATOP2
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
 961  FORMAT(1H0,25H OBSERVED GATE OPENING IS,1X,F12.3)
   
!CP   962 WRITE(IODBUG,970)(O(I),SOH(I),I=1,NOSOH)
 962  WRITE(MESSAGESTRING, 970) !(O(I),SOH(I),I=1,NOSOH)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!     $/(1X,10F12.3))
      ...
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,2,5,
     >     FORMATSTR,1,NPRINT,1,O,SOH)
      

!CP   WRITE(IODBUG,980)(ELVLG(I),QLG(I),I=1,NELVLG)
      WRITE(MESSAGESTRING, 980) !(ELVLG(I),QLG(I),I=1,NELVLG)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  980 FORMAT(1H0,112H ALTERNATING VALUES OF ELEVATION AND CORRESPONDING
     $ DISCHARGE FOR LARGE- BOARD SPILLWAY WITH ALL BOARDS DOWN ARE)
!    $/(1X,10F12.3))
      NPRINT=NELVLG
      IF ( NPRINT.GT.100 ) NPRINT=100
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,2,5,
     >     FORMATSTR,1,NPRINT,1,ELVLG,QLG)
      

      IF(NUMSM.EQ.0) GO TO 1000
!CP   WRITE(IODBUG,990)(ELVSM(I),QSM(I),I=1,NELVSM)
      WRITE(MESSAGESTRING, 990) !(ELVSM(I),QSM(I),I=1,NELVSM)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  990 FORMAT(1H0,112H ALTERNATING VALUES OF ELEVATION AND CORRESPONDING
     $ DISCHARGE FOR SMALL- BOARD SPILLWAY WITH ALL BOARDS DOWN ARE)
!    $/(1X,10F12.3))
      NPRINT=NELVSM
      IF ( NPRINT.GT.100 ) NPRINT=100
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,2,5,
     >     FORMATSTR,1,NPRINT,1,ELVSM,QSM)
      

 1000 IF(NGATE.EQ.-999) GO TO 1020
!CP   WRITE(IODBUG,1010)(ELVFL(I),QFLUD(I),I=1,NELVFL)
      WRITE(MESSAGESTRING, 1010) !(ELVFL(I),QFLUD(I),I=1,NELVFL)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1010 FORMAT(1H0,92H ALTERNATING VALUES OF POOL ELEVATION AND
     $DISCHARGE FOR FLOOD GATE FULLY OPEN ARE ) !/(1X,10F12.3))
      ...
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,2,5,
     >     FORMATSTR,1,NPRINT,1,ELVFL,QFLUD)
      

 1020 IF(NQGEN.EQ.0) GO TO 1040
!CP   WRITE(IODBUG,1030)(TOTALQ(I),QGEN(I),I=1,NQGEN)
      WRITE(MESSAGESTRING, 1030) !(TOTALQ(I),QGEN(I),I=1,NQGEN)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
 1030 FORMAT(1H0,100HALTERNATING VALUES OF TOTAL DISCHARGE AND
     $MAXIMUM GENERATION (AND/OR SLUICE) DISCHARGE ARE ) !/(1X,10F12.3))
      ...
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,2,5,
     >     FORMATSTR,1,NPRINT,1,TOTALQ,QGEN)   
      

!CP   1040 WRITE(IODBUG,1050)(STOR(I),ELEV(I),I=1,NSE)
 1040 WRITE(MESSAGESTRING, 1050) !(STOR(I),ELEV(I),I=1,NSE)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
