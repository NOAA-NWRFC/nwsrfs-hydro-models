...
C
C @PROCESS LVL(77)
      SUBROUTINE XS1126(SUNUM,PO,W,LOCWS,LOCOWS,NHRYR)
C---------------------------------------------------------------------
...
C
     ...
     .  GATEIT(10),ELVFAL(1),PEAKQ(10),PEAKEL(10),OPTEV(10),NHRYR(1)
...
!CP   1600 FORMAT('   *** ENTER XS1126 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A23)') '   *** ENTER XS1126 ***'
...
!CP   1699 FORMAT('    *** EXIT XS1126 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A23)') '    *** EXIT XS1126 ***'
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
      RETURN
      END
