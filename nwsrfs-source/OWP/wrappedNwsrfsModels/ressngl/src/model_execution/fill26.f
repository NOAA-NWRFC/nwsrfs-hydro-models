...
!CP   WRITE(IODBUG,40) IFCST,FCST,SPASSI,QPASMX,QLIMFL,QI1,QI2,QIM,QO1,
      WRITE(MESSAGESTRING, 40) IFCST,FCST,SPASSI,QPASMX,QLIMFL,QI1,QI2,
     $QIM,QO1,QO2,QOM,S1,S2,ELEV1,ELEV2,NTERP,IBUG,NS2,IUNC,CREST,STOCR,
     $SFILL,SPILMX,QOK1,QOK2,TESTPK,NUMPKO,NTOTPK,NTERPQ,QGENMX,SLUICE,
     $PCTERG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
...
!CP   140 IF (IBUG-1)200,180,150
  140 IF ( FEWSDEBUG.LT.4 ) GO TO 200
...
!CP   WRITE(IODBUG,40) IFCST,FCST,SPASSI,QPASMX,QLIMFL,QI1,QI2,QIM,QO1,
      WRITE(MESSAGESTRING, 40) IFCST,FCST,SPASSI,QPASMX,QLIMFL,QI1,QI2,
     $QIM,QO1,QO2,QOM,S1,S2,ELEV1,ELEV2,NTERP,IBUG,NS2,IUNC,CREST,
     $STOCR,SFILL,SPILMX,QOK1,QOK2,TESTPK,NUMPKO,NTOTPK,NTERPQ,
     $QGENMX,SLUICE,PCTERG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
   
!CP   WRITE(IODBUG,170)IFLAG,NSE,(STOR(I),ELEV(I),I=1,NSE)
      WRITE(MESSAGESTRING, 170)IFLAG,NSE !,(STOR(I),ELEV(I),I=1,NSE)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
