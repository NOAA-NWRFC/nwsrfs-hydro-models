...
!CP   WRITE(IODBUG,40)IFCST,FCST,IGO,NS2,QI1,QI2,QIM,QO1,QO2,QOM,
      WRITE(MESSAGESTRING,40)IFCST,FCST,IGO,NS2,QI1,QI2,QIM,QO1,QO2,QOM,
...
C
!CP   IF(IBUG.NE.2) GO TO 322
!CP   WRITE(IODBUG,321) I, IGO,NS2,UST1,UST2,RISE,DRAWEL,QI1,QI2,QQI1,
      IF ( FEWSDEBUG.LT.3 ) GO TO 322
      WRITE(MESSAGESTRING, 321) I, IGO,NS2,UST1,UST2,RISE,DRAWEL,QI1,QI2
     $,QQI1,QQI2,QO1,QQOM,QMAX,USQ1,USQ2,USQQ1,USQQ2,S1,SS1,SS2,ELEV1,
...
C ......................................................................
!CP   381 IF(IBUG-1) 500,480,390
!CP   390 WRITE(IODBUG,400)
  381 IF ( FEWSDEBUG.LT.4 ) GO TO 500
...
!CP   WRITE(IODBUG,410) (USQO(I),I=1,NUM)
      WRITE(MESSAGESTRING, 410) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  410 FORMAT(1H0,30H UPSTREAM DISCHARGE VALUES ARE) 
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,1,10,
     >     FORMATSTR,1,NUM,1,USQO)
      
!CP   WRITE(IODBUG,420) IFLAG,NSE,(STOR(I),ELEV(I),I=1,NSE)
      WRITE(MESSAGESTRING, 420) IFLAG,NSE !,(STOR(I),ELEV(I),I=1,NSE)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   WRITE(IODBUG,430) NDAMQ,(ELEVQ(I),DAMQ(I),I=1,NDAMQ)
      WRITE(MESSAGESTRING, 430) NDAMQ !,(ELEVQ(I),DAMQ(I),I=1,NDAMQ)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  430 FORMAT(1H0,58H NO. OF POINTS ON POOL ELEVATION VS MAX DISCHARGE CU
     ...
     $DISCHARGE ARE) !/(1X,10F12.3))
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,2,5,
     >     FORMATSTR,1,NDAMQ,1,ELEVQ,DAMQ)
   
!CP   WRITE(IODBUG,440) NUMM,(PEAK(I),DRAWDN(I),RATE(I),STGOPT(I),STOPEV
      WRITE(MESSAGESTRING, 440) NUMM !,(PEAK(I),DRAWDN(I),RATE(I),
!     $STGOPT(I),STOPEV(I),I=1,NUMM)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  440 FORMAT(1H0,65H NO. OF VALUES IN PEAK, DRAWDN, RATE,STGOPT,AND  STO
     ...
     $S OF PEAK, DRAWDN, RATE, STGOPT, AND STOPEV) 
!    $/(1X,2(F12.3,F10.3,F6.3,2F10.3,10X)))
      WRITE(FORMATSTR, *) '%12.3f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL,NULLLINE,5,2,
     >     FORMATSTR,1,NUMM,1,PEAK,DRAWDN,RATE,STGOPT,STOPEV)

!CP   WRITE(IODBUG,470) RULST1,RULST2
      WRITE(MESSAGESTRING, 470) RULST1,RULST2
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  470 FORMAT(1H0,60H RULE CURVE STORAGES AT BEGINNING AND END OF TIME PE
     $RIOD ARE,2F10.3)

!CP   480 WRITE(IODBUG,490)
