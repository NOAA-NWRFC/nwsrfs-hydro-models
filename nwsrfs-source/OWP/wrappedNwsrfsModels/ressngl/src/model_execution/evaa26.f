...
!CP   WRITE(IODBUG,40) IOUT,IOPTEV,ISTEP,HTARG1,HTARG2,DIFQI1,
      WRITE(MESSAGESTRING, 40) IOUT,IOPTEV,ISTEP,HTARG1,HTARG2,DIFQI1,
...
C
!CP   150 IF(IBUG.NE.2) GO TO 170
  150 IF ( FEWSDEBUG.LT.4 ) GO TO 170
!CP   WRITE(IODBUG,160) QQO1,PREVQ2,QQO2,SS1,SS2,ELRES1,ELRES2,J140
      WRITE(MESSAGESTRING, 160) QQO1,PREVQ2,QQO2,SS1,SS2,ELRES1,
     &                          ELRES2,J140
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C WRITE TRACE AND DEBUG IF REQUIRED.
C
!CP   3000 IF(IBUG-1)3350,3330,3270
 3000 IF ( FEWSDEBUG.LT.4 ) GO TO 3350
!CP   3270 WRITE(IODBUG,3280)
      WRITE(MESSAGESTRING, 3280)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   WRITE(IODBUG,40) IOUT,IOPTEV,ISTEP,HTARG1,HTARG2,DIFQI1,
     ...
     $SS2,ELRES1,ELRES2,RULEL1,RULEL2,ELVMAX,OUTMAX,PCTERN,IBUG,OPEN
      ...
      DO 3290 J=1,NGAT
!CP   3290 WRITE(IODBUG,3300) GATE(J),(EVACEL(K),EVACQ(K,J),K=1,NELEV)
 3290 WRITE(MESSAGESTRING, 3300) GATE(J),
     $                           (EVACEL(K),EVACQ(K,J),K=1,NELEV)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
...
!CP   3310 WRITE(IODBUG,3320)(STOR(I),ELEV(I),I=1,NSE)
 3310 WRITE(MESSAGESTRING, 3320) 
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
...
!CP   3330 WRITE(IODBUG,3340)
 3330 WRITE(MESSAGESTRING, 3340)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
