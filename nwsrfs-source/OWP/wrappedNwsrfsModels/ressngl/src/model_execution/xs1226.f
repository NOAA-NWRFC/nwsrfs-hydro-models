...
!CP   1600 FORMAT('   *** ENTER XS1226 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A23)') '   *** ENTER XS1226 ***'
...
C
      IST = 1
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1655)
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, 1655)
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
 1655 FORMAT('   COMBINED SPILLWAY RATING'/'       ELEV         Q')
      DO 200 I=1,NSE
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1660) PO(LESELV+I-1),W(LOCOWS(9)+I-1)
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, 1660) PO(LESELV+I-1),W(LOCOWS(9)+I-1)
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
...
C
  210 CONTINUE
      ...
      NSEND = NSE - 1
      DO 220 I=IST,NSEND
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1660) PO(LESELV+I),W(LOCOWS(9)+I)
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, 1660) PO(LESELV+I),W(LOCOWS(9)+I)
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
...
C
      DELTAT = MINODT
      NOSTEP = 0.5/SLMIN + 1
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1665) SLMIN,NOSTEP
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, 1665) SLMIN,NOSTEP
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
...
C
 9000 CONTINUE
!CP   IF (IBUG.GE.1) WRITE(IODBUG,1699) QOK2
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, 1699) QOK2 
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)  
