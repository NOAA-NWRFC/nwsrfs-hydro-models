...
!CP   WRITE(IODBUG,40) FCST,NS2,QIM,QO2,QOM,S1,S2,ELEV1,
      WRITE(MESSAGESTRING, 40) FCST,NS2,QIM,QO2,QOM,S1,S2,ELEV1,
     $ELEV2,NTERP,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   WRITE(IODBUG,40) FCST,NS2,QIM,QO2,QOM,S1,S2,ELEV1,ELEV2,
      WRITE(MESSAGESTRING, 40) FCST,NS2,QIM,QO2,QOM,S1,S2,ELEV1,ELEV2,
     $NTERP,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
   
!CP   WRITE(IODBUG,200)IFLAG,NSE,(STOR(I),ELEV(I),I=1,NSE)
      WRITE(MESSAGESTRING, 200)IFLAG,NSE,(STOR(I),ELEV(I),I=1,NSE)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
