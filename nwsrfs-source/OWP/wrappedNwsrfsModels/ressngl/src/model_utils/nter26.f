...
C
!CP   IF (IBUG.GE.5) WRITE(IODBUG,30)
...
!CP   IF (IBUG .GE. 5) ITBUG = 1
   ...
   60 CONTINUE
!CP   IF (IBUG.LT.5) GO TO 130
      IF ( FEWSDEBUG.LT.5 ) GO TO 130
!CP   70 WRITE(IODBUG,80) X,Y,IFLAG,NTERP,IBUG
   70 WRITE(MESSAGESTRING, 80) X,Y,IFLAG,NTERP,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
   80 FORMAT(1H0,21H X,Y,IFLAG,NTERP,IBUG/1X,2F12.3,3I6)
   
!CP   WRITE(IODBUG,90)(XA(I),I=1,N)
      WRITE(MESSAGESTRING, 90) !(XA(I),I=1,N)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   WRITE(IODBUG,100)(YA(I),I=1,N)
      WRITE(MESSAGESTRING, 100) !(YA(I),I=1,N)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   110 WRITE(IODBUG,120)
  110 WRITE(MESSAGESTRING, 120)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
