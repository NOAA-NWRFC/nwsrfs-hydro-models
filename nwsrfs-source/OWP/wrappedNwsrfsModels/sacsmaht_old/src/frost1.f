...
C
      SUBROUTINE FROST1(PX,SUR,DIR,TA,WE,AESC,DT,IBUG)
cInput arguments
cPX,SUR,DIR,TA,WE,AESC,DT,IBUG
cOutput arguments
cN/A
C.......................................
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /usr/apps/nwsrfs/ofs/src/fcst_sac/RCS/frost1.f,v $
     . $',                                                             '
     .$Id$
     . $' /
C    ===================================================================
...
cc      IF (LWE.EQ.0) GO TO 124
      IF (WE.EQ.0.0) GO TO 124
cc      IF (ISC.GT.0) GO TO 121
cc      COVER=1.0
cc      GO TO 122
  121 COVER=AESC
