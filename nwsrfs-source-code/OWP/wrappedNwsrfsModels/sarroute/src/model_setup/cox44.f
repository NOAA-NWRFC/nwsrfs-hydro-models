...
C                                 ANY POINTS ON THE Q-TS TABLE CHANGED
      ...
      IF (FEWSDEBUG.GE.1) THEN
        WRITE(MESSAGESTRING,111) NTSOLD,NTSNEW
 ...
 111  FORMAT('COX44: NTSOLD,NTSNEW: ',2I4)
      ...
      NPNEW = NINT(PNEW(34))
      IF (FEWSDEBUG.GE.1) THEN
      WRITE(MESSAGESTRING,112) NPOLD,NPNEW
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
 112  FORMAT('COX44: NPOLD,NPNEW: ',2I4)
      ...
      NPTNEW = NINT(PNEW(37))
      IF (FEWSDEBUG.GE.1) THEN
      WRITE(MESSAGESTRING,113) NPTOLD,NPTNEW
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
...
C                  PHASE FLOW VALUES FROM XX TO XX KEPT
            ...
            IF (FEWSDEBUG.GE.1) THEN
            WRITE(MESSAGESTRING,803) NPOLD,NPNEW,1,NPNEW
...
C                  LAST FUTURE PHASE FLOW VALUE
            ...
            IF (FEWSDEBUG.GE.1) THEN
            WRITE(MESSAGESTRING,802) NPOLD,NPNEW,1,NPOLD,
     +                     NPOLD+1,NPNEW
...
C        IF OLD # OF TIME SERIES = 1, TRANSFER OLD PREVIOUS INFLOW
      ...
      IF (FEWSDEBUG.GE.1) THEN
         DO 920 I=1,NPOLD+IOLD
            WRITE(MESSAGESTRING,902) I,COLD(I)
            call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
 902        FORMAT('COX44: I,COLD:',I4,F10.2)
 920     CONTINUE
         DO 910 I=1,NPNEW+INEW
            WRITE(MESSAGESTRING,901) I,CNEW(I)
            call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
