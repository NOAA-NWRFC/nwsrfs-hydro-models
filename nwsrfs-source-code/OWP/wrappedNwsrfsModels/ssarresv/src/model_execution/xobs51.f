...
C
 595  IF(FEWSDEBUG.LT.2 .OR. LAQO.LE.0) GO TO 600
      WRITE(MESSAGESTRING,1671) RESTYP(IRTYP)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 1671 FORMAT(3X,'** INST. OBS. DISCHARGES ** FOR ',A8,
     & 'BACKWATER RESERVOIR')
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
      write(formatstr,*)'%10.1f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL, NULLLINE,
     + 1,8, formatstr,LDOQO,LDOQO+LAQO-1,1,D)
...
C
 695  IF(FEWSDEBUG.LT.2 .OR. LAQM.LE.0) GO TO 700
      WRITE(MESSAGESTRING,1672) RESTYP(IRTYP)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 1672 FORMAT('** MEAN OBS. DISCHARGES ** FOR ',A8,
     & 'BACKWATER RESERVOIR')
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
      write(formatstr,*)'%10.1f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL, NULLLINE,
     + 1,8, formatstr,LDOQM,LDOQM+LAQM-1,1,D)
C
...
C
 795  IF(FEWSDEBUG.LT.2 .OR. LAEL.LE.0) GO TO 800
      WRITE(MESSAGESTRING,1674) RESTYP(IRTYP)
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
 1674 FORMAT(/3X,'** OBS. POOL ELEVATIONS ** FOR ',A8,
     & 'BACKWATER RESERVOIR')
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
      write(formatstr,*)'%10.2f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL, NULLLINE,
     + 1,8, formatstr,LDOEL,LDOEL+LAEL-1,1,D)
...
C
     ...
     & WK,LWQO1X,LWQO2X)
      ...
      IF(S2.LE.0.0) S2=0.0
      WK(LWST+I-1) = S2
      CALL TERP26(S2,EL2,PO(LESSTO),PO(LESELV),NSE,IFLAG,FEWSDEBUG)
      WK(LWEL+I-1) = EL2
      S1 = S2
 1100 CONTINUE
      GO TO 8000
...
C
      ...
      WK(LWEL+I-1) = EL2
      CALL TERP26(EL2,S2,PO(LESELV),PO(LESSTO),NSE,IFLAG,FEWSDEBUG)
      WK(LWST+I-1) = S2
      S1 = S2
      GO TO 2100
...
C
 ...
 1615 FORMAT(/10X,'** BACK INST. INFLOW AT PERIOD START **')
      ...
      write(formatstr,*)'%10.1f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL, NULLLINE,
     + 1,8, formatstr,LWBQI1,LWBQI1+LAOBS-1,1,WK)
C
...
C
 ...
 1616 FORMAT(/10X,'** BACK INST. INFLOW AT PERIOD END **')
      ...
      write(formatstr,*)'%10.1f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL, NULLLINE,
     + 1,8, formatstr,LWBQI2,LWBQI2+LAOBS-1,1,WK)
C
C
...
C
 ...
 1617 FORMAT(/10X,'** BACK MEAN INFLOW **')
      ...
      write(formatstr,*)'%10.1f'
      call logonedimensionarrayfromfortran(DEBUG_LEVEL, NULLLINE,
     + 1,8, formatstr,LWBQIM,LWBQIM+LAOBS-1,1,WK)
C
      WRITE(MESSAGESTRING,1680) NRUN,LAQO,LAQM,LAEL,LAOBS,ICOMB
      call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
