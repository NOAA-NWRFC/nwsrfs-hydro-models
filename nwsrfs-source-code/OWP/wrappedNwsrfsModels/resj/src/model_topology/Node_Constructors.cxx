...
/*  ==============  Statements containing RCS keywords:  */
{static char rcs_id1[] = "$Source: /fs/hseb/ob83/ohd/ofs/src/resj_topology/RCS/Node_Constructors.cxx,v $";
 static char rcs_id2[] = "$Id: Node_Constructors.cxx,v 1.3 2007/10/02 20:46:41 hsu Exp $";}
/*  ===================================================  */
