...
int Lookup3 :: setCOstring( )
{
    ...
    char temp_str[54+24+41+1];    // Labels, values, future space, end
    ...
    COtype[6] = '\0';
    sprintf( temp_str, 
        "%-12.12s%-12.12s%6.6s%-12.12s%-12.12s%24.24s%40.40s",
        COtype, _id, "-99999", "LOOKUP3", _owner->_id, value_str,
        future_str );
