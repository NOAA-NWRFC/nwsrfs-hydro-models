...
int Node :: finalizeSolution( TSDate& cur_date )
{
    ...
    {
    /*AVCP PrintDebug( 5, routine, "TIME  \"%s\".", cur_date.toString() );
    ...
    PrintDebug( 5, routine, "Outflow   %f", 
       ...
       logMessageWithArgsAndExitOnError( DEBUG_LEVEL,
       "%s Inflow   %f", routine, cur_inflow );
       logMessageWithArgsAndExitOnError( DEBUG_LEVEL,
       "%s Outflow   %f", routine, _outflow_ts.getDataValue( cur_date ) );
    }
