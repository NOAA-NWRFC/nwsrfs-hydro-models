                                  ...
                                  int offset )
{
    ...
    {
// bug #562 5/29/12    nSimulatedDates = TSDate::getNumIntervals ( 
//          getForecastDate1 ( ) , cur_date, _t_int, _t_mult ) + 1 ;

        nSimulatedDates = _totNumInterval;
...
int LagK :: setCOstring ( TSDate& cur_date )
{
    ...
    // Write the header
    sprintf ( tmp_str1, "%-12.12s%-12.12s%6.6s%-12.12s%-12.12s", "REACH", 
              _owner->_id, "-99999", _id, "LAGK" ) ;
    tmp_str1[54] = '\0' ;
    tmp_str2[0] = '\0' ;
    ...
    if ( ResJSys::addCOString ( tmp_str1 ) ) 
    {
        ...
        "%s (%s) - Troubles adding carryover data to CO array.", warnStr,
	routine ) ;
