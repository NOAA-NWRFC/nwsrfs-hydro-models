...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob83/ohd/ofs/src/resj_topology/RCS/intfgq.f,v $
     . $',                                                             '
     .$Id: intfgq.f,v 1.2 2007/10/09 13:38:52 hsu Exp $
     . $' /
C    ===================================================================
C
...
C     RETURN PARAM
      ...
      CALL FSTGQ(RCID, ICONV, ITSPOS, NVALS, TSTEP, QDATA, HDATA,LOCPTR,
     +   T1, CURVLO, CURVHI, XSECLO, XSECUP, METHOD, FLSTAG, NEEDEX, 
     +   CARRYO, JDAY, HOUR, IRCHNG, ERR_FLAG, WARN_FLG)
