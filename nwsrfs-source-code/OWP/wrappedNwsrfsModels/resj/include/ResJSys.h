...
void execute58( char* fname, float* CO, float* PO, float* D, 
	        int* d_index, int* co_da, int* co_hr, int* num_co, 
		int* st_da, int* st_hr, int* end_da, int* end_hr, 
		int* ifillc, int* iusec );
...
void carryovertransfer58 ( float* COprev, float* POprev, float* COcurr, float* POcurr,
        char* resjParamsFprev, char* resjParamsFcurr);
