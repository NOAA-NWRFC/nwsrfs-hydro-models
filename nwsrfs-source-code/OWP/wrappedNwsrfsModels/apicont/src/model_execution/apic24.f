...
C
     -KHR,IMO,IDA,IHR,IVOPT,IFRZE,LWE,LSC,IPRINT,ITP)
cCP   -KHR,IMO,IDA,IHR,IVOPT,IFRZE,LWE,LSC,IPRINT,IOUT,ITP,IBUG)
C
C*************************************************************
...
C
      ...
      DT=ITTA/24.0
      AIR=AI/AIX
cCP   CALL FRZE24(TA,LWE,WE,LSC,AESC,FI,FEI,AIR,DT,IBUG,IOUT)
      CALL FRZE24(TA,LWE,WE,LSC,AESC,FI,FEI,AIR,DT)
C
C******************************************************
...
C
  ...
  153 PGWIN=GWIN*CONV
      ...
      PFEI=FEI
C
cCP   155 WRITE(IOUT,900) IDA,IHR,PP,PRS,PAPI,PIDX,Y,PAI,PSMI,PAIF,FRS,
 155  WRITE(MESSAGESTRING,900) IDA,IHR,PP,PRS,PAPI,PIDX,Y,PAI,PSMI,PAIF,
     1 FRS,GF,PGWIN,PBFSC,PBFI,PRG,PR,PFI,PFEI
