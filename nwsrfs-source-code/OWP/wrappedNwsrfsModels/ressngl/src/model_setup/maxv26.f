...
!CP   1600 FORMAT('    *** ENTER MAXV26 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,'(A24)') '    *** ENTER MAXV26 ***' 
...
C
      ...
      MAX = MAX0(MAX,NEVSQ)
C
!CP   IF (IBUG .GE. 2) WRITE(IODBUG,1610) IBASE,LEVEL,NEVSQ,MAX
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, 1610) IBASE,LEVEL,NEVSQ,MAX
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
...
!CP   1699 FORMAT('       *** EXIT MAXV26 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A26)') '       *** EXIT MAXV26 ***'  
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
      RETURN
      END
