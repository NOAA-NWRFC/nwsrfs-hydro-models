...
C
     ...
     .           4HGENQ,4H    ,4HSLUI,4HCEQ /
      ...
      DATA NDKEY/2/
C
!CP   DATA UINT/4HINT /,DLES/4HDLES/
      DATA BLANK/4H    /
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      IF (TRIM(UCODE).EQ."INT") GO TO 150
C
...
C
  150 CONTINUE
      IF (TRIM(DCODE).EQ."DLES") GO TO 160
C
      CALL STER26(46,1)
      GO TO 10
C
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      IF (TRIM(UCODE).EQ."INT") GO TO 250
C
      CALL STRN26(93,1,TRIM(UCODE),1)
      GO TO 10
C
...
C
  250 CONTINUE
      IF (TRIM(DCODE).EQ."DLES") GO TO 260
C
      CALL STER26(46,1)
      GO TO 10
C
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      IF (TRIM(UCODE).EQ."CMSD") GO TO 450
C
      CALL STRN26(93,1,TRIM(UCODE),1)
      GO TO 10
C
