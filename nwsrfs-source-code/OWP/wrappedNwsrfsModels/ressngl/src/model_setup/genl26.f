...
C
!CP   DO 360 I=1,3
!CP      CALL FCONVT(UNITC(I),DIM(I),UENG,CONVT(I),CONST,IERC)
!CP  360 CONTINUE
! Don't want to call FCONVT; Hard code non changing conversion factor
!!!!
C Convert meters to feet (M to L)
      CONVT(1) = 3.280840
C Convert cmsd to cfsd (CMSD to L3)
      CONVT(2) = 35.31431
C Convert cmsd to cfsd (CMS to L3/T)
      CONVT(3) = 35.31510
C
...
C
 1000 CONTINUE
      IF (NUMERR.EQ.0.AND.NUMWRN.EQ.0.AND.FEWSDEBUG.LT.3) GO TO 9999
