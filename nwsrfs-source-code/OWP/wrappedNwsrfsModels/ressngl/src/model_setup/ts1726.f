...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      IF (TRIM(UCODE).EQ."CMS") GO TO 150
C
...
C
  150 CONTINUE
      IF (TRIM(DCODE).EQ."L3/T") GO TO 160
C
      CALL STER26(46,1)
      GO TO 10
C
...
!     CALL getDimensionAndUnitInFortran(DTYPE(NPR), DCODE, UCODE)
      UCODE = 'CMS'
      DCODE = 'L3/T'
      IF (TRIM(UCODE).EQ."CMS") GO TO 450
C
      CALL STRN26(93,1,TRIM(UCODE),1)
      GO TO 10
C
...
C
  450 CONTINUE
      IF (TRIM(DCODE).EQ."L3/T") GO TO 460
C
      CALL STER26(46,1)
      GO TO 10
C
...
!     CALL getDimensionAndUnitInFortran(DTYPE(NPR), DCODE, UCODE)
      UCODE = 'CMSD'
      DCODE = 'L3'
      IF (TRIM(UCODE).EQ."CMSD") GO TO 550
C
      CALL STRN26(93,1,TRIM(UCODE),1)
      GO TO 10
C
...
!     CALL getDimensionAndUnitInFortran(DTYPE(NPR), DCODE, UCODE)
      UCODE = 'CMSD'
      DCODE = 'L3' 
      IF (TRIM(UCODE).EQ."CMSD") GO TO 750
C
      CALL STRN26(93,1,TRIM(UCODE),1)
      GO TO 10
C
