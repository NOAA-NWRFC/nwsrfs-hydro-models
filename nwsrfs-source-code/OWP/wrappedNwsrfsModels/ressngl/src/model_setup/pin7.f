...
CFC   CALL ERROR
C
CFC130   IF (ITB.GT.0) CALL CHEKTS (TSIDB,DTB,ITB,IS0,IDIMO,IS1,IS1,IER)
C
...
!CP   WRITE(*,*) 'IDIMI = ', IDIMI
CFC   CALL ERROR
      GO TO 330
230   IF (IDIMI.EQ.'L3/T') GO TO 240
!CP   WRITE (IPR,220) IDIMI
...
!CP   IF (IBUG.GT.1) WRITE (IODBUG,250) (P(IP+NP),NP=1,IX)
      IF ( FEWSDEBUG.EQ. 4 ) THEN
         WRITE(MESSAGESTRING, 250) !(P(IP+NP),NP=1,IX)
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
250      FORMAT (' P=') !,10F10.2)
     ...
     >        FORMATSTR,IP+1,IP+IX,1,P)
      ...
      DO 280 NP=1,JLG
         L1=IP+NP*2
         L2=L1+2
!CP      IF (IBUG.GT.1) WRITE (IPR,260) L1,L2,P(L1),P(L2)
         IF ( FEWSDEBUG.EQ. 4 ) THEN
...
!CP      WRITE (IPR,310) NPAIR,LAGWRD,P(I)
...
!CP         WRITE (IPR,310) NPAIR,KWRD,P(IP+I)
...
440   P(16)=IP+.01
      ...
      IF (IER.EQ.1) GO TO 560
C
!CP   IF (IBUG.GT.0) WRITE (IODBUG,*) 'NDFLT=',NDFLT
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, '(A6),I6') 'NDFLT=', NDFLT
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
C
      IF (NDFLT.LT.0) THEN
!CP      WRITE (IPR,450) NDFLT
...
!CP   IF (IBUG.GT.0) WRITE (IODBUG,*) 'LAG OPTION ENABLED'
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, '(A18)') 'LAG OPTION ENABLED' 
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
C.......................................................................
C
...
!CP   IF (IBUG.GT.0) WRITE (IODBUG,*) 'K OPTION ENABLED'
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, '(A16)') 'K OPTION ENABLED'
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
      IY=2
      IX=3
