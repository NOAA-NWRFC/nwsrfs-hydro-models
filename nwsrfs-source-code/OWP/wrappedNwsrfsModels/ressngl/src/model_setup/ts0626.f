C MEMBER TS0626
C  (from old member FCTS0626)
C
      SUBROUTINE TS0626(WORK,IUSEW,LEFTW,NTS06,
     .            LENDSU,JDEST,IERR)
C--------------------------------------------------------------------
C  ROUTINE TO GET AND CHECK TS SPECIFICATIONS FOR S/U #06 -
...
C
     ...
     .          INPUT(2,2),LINPUT(2)
      DIMENSION WORK(1)
C
      LOGICAL TS1OK,TS2OK,ALLOK,ENDFND
C
C    ================================= RCS keyword statements ==========
      CHARACTER*68     RCSKW1,RCSKW2
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/rfc/ofs/src/fcinit_res/RCS/ts0626.f,v $
     . $',                                                             '
     .$Id: ts0626.f,v 1.1 1995/09/17 18:53:16 dws Exp $
     . $' /
C    ===================================================================
C
C
      DATA INPUT/4HQGEN,4H    ,4HQSLU,4HICE /
      DATA LINPUT/1,2/
      DATA NINPUT/2/
      DATA NDINPU/2/
C
...
C
!  145 CONTINUE
!      CALL FDCODE(DTYPE(IDEST),TRIM(UCODE),X,IX,IX,X,IX,IERD)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      CALL getDimensionAndUnitInFortran(DTYPE(IDEST), DCODE, UCODE)
