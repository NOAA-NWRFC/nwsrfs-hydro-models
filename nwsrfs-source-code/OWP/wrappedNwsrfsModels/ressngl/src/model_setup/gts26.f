...
!CP   INCLUDE 'common/fdbug'
      INCLUDE 'flogm'
C
!CP   DIMENSION KEYWDS(2,9),LKEYWD(9),UC(6),DIM(6),WORK(1)
      DIMENSION KEYWDS(2,9),LKEYWD(9),WORK(1)
...
C
      ICHK = 0
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1666) ICHK
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, 1666) ICHK
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      IF ( TSIO(ID) .EQ. 1.01 ) THEN
         UCODE = 'CMSD'
	 DCODE = 'L3'
      ELSE
         CALL getDimensionAndUnitInFortran(DTYPE(ID), DCODE, UCODE)
      END IF

      IF (TRIM(UCODE).EQ.UC(ID)) GO TO 230
C
...
C
  230 CONTINUE
      IF (TRIM(DCODE).EQ.DIM(ID)) GO TO 10
C
      CALL STER26(46,1)
      TSOK(ID) = .FALSE.
      GO TO 10
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  
      UCODE = UC(ID)
      DCODE = DIM(ID)
      IF (TRIM(UCODE).EQ.UC(ID)) GO TO 330
C
      CALL STRN26(93,1,TRIM(UCODE),1)
      TSOK(ID) = .FALSE.
      GO TO 10
