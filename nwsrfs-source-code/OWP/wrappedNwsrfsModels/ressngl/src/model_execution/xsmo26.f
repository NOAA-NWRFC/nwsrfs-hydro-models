...
!CP   1600 FORMAT('   *** ENTER XSMO26 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A23)') '   *** ENTER XSMO26 ***'
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
C
C  WRITE INST. SIM. DISCHARGES
C
!CP   IF (IBUG.LT.2) GO TO 10
...
!CP   WRITE(IODBUG,1650) (W(LOCTRI+I-1),I=1,NUM)
...
!CP   1699 FORMAT('    *** EXIT XSMO26 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A23)') '    *** EXIT XSMO26 ***'
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
      END IF
      RETURN
      END
