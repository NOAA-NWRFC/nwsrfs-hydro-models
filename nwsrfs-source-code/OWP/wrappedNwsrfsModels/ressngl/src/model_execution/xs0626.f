...
!CP   1600 FORMAT('   *** ENTER XS0626 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A23)') '   *** ENTER XS0626 ***'
...
C
C  THE FOLLOWING CHANGE MADE ON 12/14/90 -- M624
!CP   IF(IBUG.LT.1 .OR. NS2.GT.1) GO TO 202
      IF ( FEWSDEBUG.LT.3 .OR. NS2.GT.1) GO TO 202
...
!CP   WRITE(IODBUG,1630) (D(I),I=IST,IEND)
...
!CP   IF(IBUG.LT.1 .OR. NS2.GT.1) GO TO 252
      IF(FEWSDEBUG.LT.3 .OR. NS2.GT.1) GO TO 252
...
!CP   1699 FORMAT('    *** EXIT XS0626 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A23)') '    *** EXIT XS0626 ***'
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF 
      RETURN
      END
