...
!CP   1600 FORMAT('   *** ENTER XU2326 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A23)') '   *** ENTER XU2326 ***'
...
C
      ...
      IPOS = 0
C
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1650) TYPE(1,IWHICH),TYPE(2,IWHICH)
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, 1650) TYPE(1,IWHICH),TYPE(2,IWHICH)
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
...
C
      ...
      LOCSUV = LOCWS(3)
C
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1660) NSCHEX
      IF ( FEWSDEBUG.GE.3 ) THEN
         WRITE(MESSAGESTRING, 1660) NSCHEX
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
...
C
!CP   IF (IBUG.GE.2) WRITE(IODBUG,1665) I,VCHEK
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, 1665) I,VCHEK
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
...
!CP   1699 FORMAT('    *** EXIT XU2326 ***')
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING, '(A23)') '    *** EXIT XU2326 ***'
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
      END IF
      RETURN
      END
