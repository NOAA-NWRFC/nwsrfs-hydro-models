...
!CP   WRITE(IODBUG,40) IFCST,FCST,QI2,QIM,QO1,QO2,QOM,S1,S2,ELEV2,NTERP,
      WRITE(MESSAGESTRING, 40) IFCST,FCST,QI2,QIM,QO1,QO2,QOM,S1,S2,
     $ELEV2,NTERP,IBUG
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
!CP   110 IF(IBUG-1)170,150,120
  110 IF ( FEWSDEBUG.LT.4 ) GO TO 170
...
!CP   WRITE(IODBUG,140)IFLAG,NSE,(STOR(I),ELEV(I),I=1,NSE)
      WRITE(MESSAGESTRING, 140) IFLAG,NSE !,(STOR(I),ELEV(I),I=1,NSE)
      call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
