...
#define OUTPUT_HTML_FILE_NAME "outputHTMLFileName"
#define HTML_CSS_FILE_NAME "HTMLCSSFileName"
...
typedef struct ModelArgs
{
   ...
   char outputHTMLFile[FILE_NAME_LENGTH];
   char HTMLCSSFile[FILE_NAME_LENGTH];
